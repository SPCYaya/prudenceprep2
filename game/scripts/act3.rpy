...
label cloverdecorations:
    ...
    "It's true that plenty of my time is taken up with school work, and now lacrosse, but the rest of the time I spend just following Sibyl around to whatever her latest occupation may be."
    "I'll never turn down the chance to be by her side, but sometimes I just wish we could do something other than go to the library or art room."
    ...
    "Sibyl was the one to agree to help put up the Saint Patrick's Day decorations even though she pointedly asked {b}me{/b} if the two of us could do the task."
    "It's absolutely no mystery to me why I in particular should be asked to do this task, and when I open the box of decorations I find exactly what I expected starting back at me."
    C "Here's the next shamrock, Sibyl."
    S "Thanks for the clover, Clover!"
    "Such an exclamation would normally make me mad, but given it's Sibyl saying it, and with how cute and cheery she looks when she says it, the bile never rises inside."
    C "Really, shouldn't the Student Council or something be doing this? Why do {b}we{/b} have to put up the decorations?"
    S "Because Miss Woolsey asked us to."
    "Sibyl finished hanging the final shamrock around the arch of a window and steps off the stool to move to the next."
    ...
    "Sibyl has a point, though I do not want to admit it."
    S "Okay, next shamrock, please!"
    "I dig into the box and retrieve the next green paper shamrock to pass up to Sibyl."
    "My own feet remain on the ground, and I try my best to ignore how close I am to seeing right up Sibyl's skirt if only I were to bend just a {b}little{/b} bit more."
    ...
    "I reach into the box aimlessly to put out another decoration and lifting it high up for Sibyl to grab, but it never leaves my fingers."
    S "How did that in there?"
    C "Hmm?"
    "I turn my head up from where I'd been averting my gaze from Sibyl to see what I'm holding, and find a paper decoration in the shape of a stick with berries and a red ribbon."
    C "What's this?"
    "The question is spoken aloud, and Sibyl, who hops down off the step stool before me, is the one to answer."
    S "It's a mistletoe, part of the Christmas decorations."
    C "A mistletoe..."
    ...
    S "...see if Miss Woolsey can find the Christmas decorations box when we're done."
    "I come back to myself the instant Sibyl reaches out to take the mistletoe from me, but don't let it go. I don't let her have it. I don't want the mistletoe held aloft between us to go away yet, not when I'm still wavering."
    C "(Damn it, Clover, you're not going to get a better chance than this!)"
    "I can feel myself shaking all over, but somehow my muscles all feel stiff and brittle like they'll shatter with any tiny movement."
    S "Clover?"
    ...
    "What is only a fraction of a second movement leads to a few silent seconds where we merely stare at each other after."
    ...
    S "C-Clover..."
    "My beloved roommate doesn't look angry, but she also doesn't look happy. If anything, she's {b}shocked{/b}."
    "I'm also shocked, that's for sure. I don't know what reactions I expected out of her, but this surely wasn't it."
    ...
    "I was aiming for the lips, but maybe it's actually better that she instinctively flinched enough that I kissed her on the cheek. I wouldn't have been able to come back from it otherwise."
    "Not that I'm coming back from it at all now. Sibyl still hasn't lowered her hand from her cheek, and now she's not even looking my direction at all."
    C "S-Sorry...!"
    ...
    "My eyesight rapidly becomes flurry as I rush through the hallway. I bump into things around me more than once while totally unaware whether it's another human or piece of furniture."
    "None of it matters."
    C "(Sibyl is gone. Forever.)"
    "As I reach the end of the hallway at the far end of the school and merely stand there huffing and puffing before a great big window."
    "The urge to simply throw my worthless body right out of it bubbles up strong from deep inside me and I fumble with the latch for a brief moment, but with how shaky my hands are I cannot manage the latch."
    "Giving it up entirely, I turn swiftly on my feet to run away somewhere else to hide but end up suddenly halted by something firm around my waist."
    mw "Got you!"
    ...
    "In another moment I'm forcibly shuffled aside by the very same athletics teacher and seated right down atop a cushioned platform, which I quickly come to realize is a bed."
    ...
    "When my mind settles better into the moment, I realize this must be Miss Woolsey's room in the dorms, as it is clearly not mine."
    "There are cat-themed items everywhere, including the bedspread, and what isn't full of cats features anime imagery entirely unknown to me."
    ...
    "Then the whirlwind of the past few moments and the strangeness of the inside of my teacher's room fades, leaving me once again to plummet into the depths of despair."
    "A heavy sob bubbles up from my chest and I croak out a simple \"no\" in reply."
    "Miss Woolsey sits down beside me on the bed and rests her hand on my shoulder. I don't really need the sympathy, but in the desperate state I am in, I'm unable to shrug it off."
    "She waits a few moments while I do a few deep breathing exercises to calm myself down further."
    "As much as I don't need the sympathy of her sitting beside me, having someone there to see me in such a state is useful in that there's no way I'm looking so absolutely pathetic in front of anyone."
    mw "Would you like to tell me what happened?"
    C "N-No..."
    "But I do anyway, slowly and painfully."
    "It hurts to get through, but as I recount what happened in what feels a lifetime ago, I feel a little better about myself and that maybe the world hasn't ended."
    C "(Maybe I overreacted... a tiny bit.)"
    "I know that is putting it lightly, but after calming down and thinking it through, I am only ashamed that I almost tried to end it all over something to little."
    ...
    mw "I'm so sorry, Clover. I didn't think it would—!"
    C "You put the mistletoe in the box, didn't you?"
    mw "Yes... I wanted to help the twins with— well, you know."
    C "(Is there anyone those twins {b}haven't{/b} told?)"
    ...
    C "Listen, umm... I'm fine now. So thanks. And, uhh, it's all my fault, so don't feel bad."
    "It's so awkward to do but I don't want to make Miss Woolsey feel so terrible any more than she deserves, and she {b}did{/b} just possibly prevent me from doing something really, really dumb."
    ...
    "I don't know what happens next either. There's no reason for me to stay here in my teacher's bedroom, but I also don't exactly cherish the thought of facing Sibyl again so soon."
    C "What... what do you think I should do, Miss Woolsey?"
    "I know I probably shouldn't expect my gym teacher to give me any particular advice here, but I'm lost and don't want to have to tell the guidance counselor about everything too."
    mw "That's a... good question."
    C "(She's clueless. She's probably never even had a boyfriend before, I mean, she's a {b}gym teacher{/b}.)"
    "It's just in that moment where I am thinking terrible things about how Miss Woolsey's life could have gone so wrong so quickly that the door to her room swings open and shut beside us."
    mi "Nao-chaaaan~! Lemme squeeze your tits!"
    "Miss Izzie throws herself through the door wailing exaggeratedly for her special assistance like a thirsty woman stranded in the desert."
    "When she finally sees me, she pauses with obvious confusion."
    mw "Izzie! I'm with a student right now!"
    mi "...I'm not sharing."
    "After delivering what I believe is a joke, Miss Izzie traipses close to flop onto the bed beside her friend."
    mi "So what's up?"
    "Miss Woolsey and I share a look in which my permission is granted, and then she recount what happened in only as much detail as necessary."
    mi "See, this is why straight girls are the worst."
    mw "Izzie, {b}please{/b} try to show some tact. Clover's in a lot of pain and terribly confused right now."
    ...
    "This is apparently terrific news, but entirely useless to me, and so I clear my through to get them back on topic and just maybe help me work out how to piece together my life once again."
    ...
    C "I know, but... After freaking out as much as I did when I thought I'd lost her for good, maybe I should just take a step back."
    C "I'd rather stay by Sibyl's side as her friend than lose her if I push too hard."
    mi "{b}No!{/b}"
    ...
    "In the end, neither of them really helps me decide what I need to do, because it's at that moment that a knock at the door disrupts our conversation."
    S "Miss Woolsey, I've finished putting up the shamrocks."
    S "...And have you seen Clover anywhere?"
    "Both of my teachers immediately look my way, and with a small nod, I reluctantly find myself walking back to my room side by side with Sibyl."
