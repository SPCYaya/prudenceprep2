...
label cloverdecorations:
    ...
    if secret_lilies_romance == "blanche":
        ...
        "Miss Woolsey apparently can't be any more of a cliché female gym teacher than she is now."
    ...
    C "Well, no, but—"
    mi "No \"buts\"! Either make her your girl or move on."
    ...
    mw "You've tried everything you possibly could already, haven't you? Perhaps you should just confess to her directly."
    ...
    "Both of my teachers give me what essentially amounts to the same advice. They believe that it's time for me to end it now, one way or another."
    scene bg hallway with dissolve
    "After giving me her final advice, Miss Woolsey manages to scrape me off the table to walk me back to the dorms despite the dread of facing Sibyl increasing with each step."
    "We only make it a few doors through the hallway before I spot a bounce of auburn curls and quickly duck behind Miss Woolsey walking beside me."
    S "Miss Woolsey, I've finished putting up the shamrocks."
    mw "That's great, Clover!"
...
label failed_confession:
    ...
    "Though she normally is happy to help me with something, this evening she just tosses out a reference to what page to find it in the textbook without even looking my way."
    C "(Yup, she's definitely on guard like crazy. I guess I have no choice now but to come clean.)"
    "I already feel sick to my stomach just thinking about it, but I probably hit the point where I either go for broke or die trying way before today's disaster anyway."
    C "H-Hey, Sibyl..."
    ...
    S "...Yeah?"
    "Sibyl turns to face me, finally, and when I tell her I need to talk about the kiss, she again goes white as the snows outside the window."
    C "I'm sorry, and... I-I love you."
    "The words are practically spit out of my mouth, and the reaction from Sibyl isn't any too promising. I wait patiently as she remain quiet or a distressingly long time."
    S "You... love me."
    "I can already tell this isn't going well for me but it's probably best to just get it all out now."
    "The small fraction of me that isn't shaking in my uniform still has some small hope that the idea might implant deep enough in her mind for her to come around."
    C "(This must be way out of the blue for her, and that's why she's so shaken about it?)"
    "Trying to make the moment perhaps a little romantic and salvage this setback, I try to bring to mind what I like about her so much."
    ...
    C "(She's afraid to even touch me. Sibyl is afraid of me; she's {b}afraid{/b} of my {b}love{/b}.)"
    ...
    C "(Why me?)"
    "Of all the things I feel in the moment, that is what I find most strange when the thoughts filters through my mind."
    C "(Why me? Why does my first love have to be this hard? Why can't it just work out perfectly like in every single book and movie that have ever existed?)"
    C "(Why do I have to feel this much {b}pain{/b}? Haven't I had enough torment in my life lately?)"
...
label heart2heart:
    ...
    "When the hour hand rolls back around to twelve, I finally toss the sheets off and throw on my uniform so I can stealthily fetch some lunch and sneak it back to my room."
    "Just as I'm finishing tying the ribbon around my neck, the door unexpectedly swings wide open."
    C "S-Sibyl!"
    "I immediately brace myself for the flutter of auburn curls which will surely be coming through the doorway, but it's not Sibyl who walks first through the opening."
    T "{b}Clover!{/b}"
    "It's Tanya, and boy does she ever look pissed."
    ...
    "Little of the vitality and vivaciousness I find so endearing in Sibyl is preset today, replaced instead by the shadowed eyes of someone who got as little sleep as I did the night before."
    ...
    "The sole reason that Sibyl is looking at pitiful as she does now is because I did all sorts of things without considering her feelings, just as Tanya warned me against."
    ...
    "From my peripheral vision I can tell that Sibyl is doing much the same. Her arms are crossed over her chest in such an insecure manner that it only makes me more guilty."
    ...
    S "Stop! No {b}fighting{/b} in my room!"
    ...
    S "So you... \"love\" me?"
    C "Y-Yeah..."
    S "But {b}why{/b}? Why do I attract all of this affection?"
    ...
    S "But I'm {b}not gay{/b}, Clover! Why can't anyone just be my friend without wanting any more than that?"
    C "I-I... umm..."
    ...
    C "You... what?"
    S "I'm sorry. I already kind of... suspected you had these feelings for me, but didn't know how to react."
    S "I guess I just hoped I could ignore it and it would go away like I've always done."
    ...
    "At the same time, I was hoping I could just keep pushing her further until she finally returned my feelings."
    "It's with a dark humor that I feel like we're both two rotten peas in a pod."
    C "I'm... sorry too. I never meant to burden you with all this emotional torment over my own stupid, clumsy feelings."
    C "I guess I really messed up too, thinking that maybe if I pushed a little harder you might fall for me eventually."
    S "I'm {b}straight{/b}, Clover. There's nothing I can do to change that. Besides, I've told you about my plans for the future and I mean to make them come true."
    ...
    "But on another level, I just cannot stand that something as dumb as being born with the same lady parts should stand in the way of my feelings now."
    C "How do you know if you've never tried it?"
    "A wave of regret washes over me the moment the question leaves my lips, followed by a strong rip current of guilt."
    C "(I'm pushing my emotions onto Sibyl again.)"
    ...
    S "Yeah, I have."
    "The thought that someone else has already soiled Sibyl's lips strikes a hot jealousy streak inside me but I try to keep it down lest Sibyl retract her offer to kiss."
    ...
    "I spare not a single thought in taking the request back, however guilty I may be."
    S "Well...?"
    ...
    "Steeling myself, I push my still body forward at her with all my strength only to find that she leans slightly back away from me at the same time. Shocked and hurt, I cannot help but immediately call out."
    C "You moved away—!"
    ...
    "It's incredible beyond words, and not just the kiss itself. The warmth of her hand against my cheek, the gentle tickle of her exhale against my face, and the sweet smell of her shampoo are all divine."
    "I want the kiss to last a lifetime. I {b}need{/b} to sink deeper into Sibyl. I lean forward slightly to return the kiss with a much confidence as i can muster, but as I do Sibyl's body yields back."
    "Her hand leaves my cheek to brace against my chest, keeping me from falling atop her as she pulls away, and my eyes open lowly in accordance wth desire flooding through my body."
    C "Wow..."
    ...
    "Her bed freaks quietly as she rises from it, leaving me alone upon it. A million thoughts race through my head but my mind is still lost in the confusing haze."
    S "Would you like to come to lunch with us, Clover?"
    "Sibyl is in much more a hurry to move on from the moment than I am. The awkwardness ic clear in her voice despite how well she's trying to hide it."
    ...
    "As much as I'd like to have continued to believe that was some slim amount of hope, it's better now for all of us that my feelings were put into the open and things were worked out with Sibyl."
...
label languishing:
    ...
    O "We feared the worst when we heard you hadn't been to any of your classes."
    ...
    C "Go away!"
    "The feeling of two heavy weights depressing down the bottom of my bed indicate that neither has left me as I demanded."
    H "Is that any way to greet your thoughtful student council representatives when they come to check upon you in your darkest hour?"
    C "La-la-la I'm not listening. Everything you say ends up making my life worse."
    "There's no doubt in my mind that the twins are in some way aware of what happened with Sibyl, and I'm not about to let either of them ruin my mood further."
    O "She says she's not listening, Vittoria. What do we do now?"
    H "I say we just have our way with her, Vincenza."
    O "All students are in class now. There will be no one to hear her scream."
    ...
    C "{b}Don't you touch her!{/b}"
    "I whip my cocoon apart dramatically to stare down the twins, bursting from my sheets like a vengeful butterfly newly born from her silken shell."
    O "Relax, Clover, we're just teasing you."
    ...
    H "We are only here to see how you are doing, honestly."
    "I flop back down sluggishly onto my bed facing the twins, relaxed but not off guard."
    C "What does it matter to you anyway? Haven't you done enough already?"
    H "Is it not the President's duty to look after the wellbeing of her charges?"
    ...
    O "Is there anything we can do to ease your feelings?"
    ...
    C "...Tell me how to get over S-Sibyl."
    "However intense the emotional turmoil was to start with, I have come to accept that I will have to go back to being friends and roommates with Sibyl."
    "But just because I accepted this conclusion, however, does not mean everything is now fine and dandy. My heart still feels like a sponge being wrung out every time I look at her or say her name."
    ...
    O "Your feelings may never subside, Clover. You'll likely continue to admire all those things which first drew you to Sibyl."
    ...
    H "Hold up, you kissed her? {b}She{/b} kissed {b}you{/b}?"
    "Like a total dunce I spill the beans on my selfish request to Sibyl and which she had selflessly granted despite not liking me in that way."
    C "You can't tell {b}anyone{/b}, least of all Tanya."
    ...
    "Under pressure from the twins, I relate a shortened version of what happened in exchange for an assurance of their secrecy in the matter."
    H "I must applaud you in this endeavor, Clover. You've succeeded where Vincenza and I had not."
    "It feels good to have the twins voluntarily admit I'm their better in at least one way, but that feeling doesn't remain as the reminder that they once tried to makes their moves on Sibyl follows."
    C "So yeah, she's all I think about and I just can't think clearly anymore."
    ...
    "To my surprise, Vittoria and Vincenza both immediately tell me how this is exactly the {b}wrong{/b} way to do it."
    ...
    O "Yeah, we did say that, but we meant after you fully come to terms with how things ended with Sibyl and are ready to move on."
    C "But you said I'd never get over Sibyl!"
    "The twins shut up for once in the face of my superb reasoning, but neither look too happy about it."
    ...
    H "Clover, I know you're hurting right now but you don't want to do anything you're going to regret later."
    C "(They tell me all these things about how it's not going to be easy to move on Sibyl, then tell me the one way that I'll get over her, then tell me that I can't do it!?)"
    ...
    O "We're not as heartless nor as evil as you think we are, Clover. All the girls we play with {b}desire{/b} our affection."
    "My heart rate reaches a peak yet again, having been slowly climbing over the last minute. After everything they've done, now of all times do the twins act shy."
    C "i take back everything I told you before. Permission to touch {b}granted{/b}."
    "Both Vittoria and Vincenza balk at my sudden change of heart, looking more than mildly perturbed by the barely hidden meaning behind what I said to them."
    H "You're not in the right state of mind, Clover."
    O "Don't ask us to do something that we know might hurt you."
    ...
    H "Are you {b}sure{/b} you want this, Clover?"
    O "Is this really how you want your first time to be?"
    "The twins correctly guessing that it's my \"first time\" only makes me more annoyed by their current resistance to do what they normally do without a care."
    C "Yes, I am very sure!"
    "The twins silently debate whether they're actually going to do what I ask, and though they don't tell me what they've decided, their actions speak the words they choose not to utilize."
    ...
    "I do as Vincenza asks, though I find it increasingly hard to calm down as I feel Vittoria creep higher and higher up my thighs, reaching about no doubt to work my tights off my body."
    ...
    "The tip of Vincenza's tongue glides softly across my upper lip and I cannot help but release a soft whimper in response. She pinches my lower lip between hers, sucking on it ever so faintly to drive my senses wild."
    "I want to kiss so much more, and so much more {b}deeply{/b}, but Vincenza holds herself back like the maddening tease she is. Below, Vittoria's hands glide all the way up to my hips."
    ...
    "Greedy fingers take the opportunity to tug my tights and panties effortlessly down my legs while equally rapacious lips return to stifle the breathy whimpers of desire which bubble up from my chest."
    "My heartbreak-wearied mind races once more, alight with new-found discoveries of sensations previously unknown."
    scene bg black with fade
    pause 5.0
    scene bg bedroom with fade
    "For the longest time after the twins leave, I remain lying in my bed naked staring blankly up at the ceiling above me."
    ...
    "In fact, I doubt I'll ever be able to look either one in the face ever again."
    ...
    "With the knowledge that classes will surely be letting out sooner rather than later, I make my way through a shower and get re-dressed for her eventual return."
    S "Good afternoon, Clover. How are you feeling?"
    "When Sibyl does eventually come sweeping back through the door to our room, it's with a perhaps contradictory relief that I feel a prickle in my chest upon seeing her face."
    ...
    S "That's great! I was worrying that I'd have to dump all this homework on you while you were still in a poor state of mind."
    C "Wait, what?"
    ...
    C "But I haven't even seen the lectures for half this stuff. Will you help me, Sibyl?"
