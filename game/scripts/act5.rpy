...
label peltingballs:
    ...
    "With no more left to say, we both turn away from one another to change out of our uniforms from either side of the bench where our lockers reside."
    "We change together in the locker room just like this almost every day, but somehow today the silence between us seems even more uncomfortable than usual."
    C "(What's she thinking?)"
    ...
    "My head whips back around in the next fraction of a second, and my body quickly continues the normal routine while my mind ponders the awkward, silent exchange."
    C "({b}Why{/b} was Tanya looking at me?)"
    ...
    scene bg hallway with dissolve
    "With my school uniform now re-equipped, I exit the locker room first an am immediately beset by Sibyl just outside the door."
