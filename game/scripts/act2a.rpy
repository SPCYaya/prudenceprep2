label howto:
    ...
    "My legs walk on auto pilot while I dream up grand strategies to win over Sibyl and plans for throwing my victory in the faces of all my doubters — mostly the latter."
    show clover deer at mright
    ...
    S smile "Good morning, Clover! Are you feeling better today?"
    hide sibyl
    hide clover
    show clover neutral at center with dd
    "After fending off her concerns for my supposed illness and making an excuse for my absence, I sit down at my desk to try to actually do some of that homework which I had blown off yesterday."
    C frown "(The sine is... the ratio of the side opposite the angle to the hypotenuse.)"
    C smile "(...Hippopotenuse. Sibyl would think that's funny.)"
    ...
    C neutral "(Homework now. Sibyl later.)"
    ...
    C happy talk "(\"Six Simple Steps\"? Is that all it takes?)"
    ...
    C frown "(Sibyl has it worse than me. She never even knew her parents.)"
    ...
    C neutral "(Step Three: Take an interest in her!)"
    ...
    C smile "(I've already been doing that, but I can do more too!)"
    ...
    C frown "(Step Four: Befriend her friends!)"
    ...
    C scowl "(If it means making Sibyl mine... I will do it.)"
    ...
    S @ neutral talk "What's up, Clover? Need some help with the homework?"
    ...
    C @ contemplative "(Now to try out flirting...)"
    show choice_darkness with dissolve
    menu:
        "\"Your eyes are so pretty.\"":
            hide choice_darkness with dissolve
            C happy talk "Your eyes are so pretty."
        "\"Your hair is so fluffy.\"":
            hide choice_darkness with dissolve
            C happy talk "Your hair is so fluffy."
        "\"Your shampoo smells amazing.\"":
            hide choice_darkness with dissolve
            C happy talk "Your shampoo smells amazing."
    C smile "(And finally, take an interest in her!)"
    show choice_darkness with dissolve
    menu:
        "\"What's your favorite color?\"":
            ...
            S contemplative "Umm, thanks, and... yellow."
        "\"Are you a morning person or a night owl?\"":
            hide choice_darkness with dissolve
            C @ happy talk "Are you a morning person or a night owl?"
            "Everything I've done is a sure win, or so I think initially, but every passing microsecond that Sibyl gives me a strange look like I'm not even speaking English lessens my confidence."
            S contemplative "Umm, thanks, and... probably a night owl if had to choose."
        "\"What is your astrological sign?\"":
            hide choice_darkness with dissolve
            C @ happy talk "What is your astrological sign?"
            "Everything I've done is a sure win, or so I think initially, but every passing microsecond that Sibyl gives me a strange look like I'm not even speaking English lessens my confidence."
            S contemplative "Umm, thanks, and... Libra."
    S frown talk "Are you sure you're feeling all right, Clover?"
...
label failed_seduction:
    ...
    show sibyl contemplative at mright
    show tanya frown alt2 at right
    with dissolve
    ...
    S neutral talk "Is there something wrong with the other side of the table, Clover?"
    C smile "No. I just felt like sitting next to you today."
    ...
    S frown "That's all well and good, but I feel like a sardine."
    ...
    C frown talk "But I want to sit beside Sibyl too!"
    S angry "You can both be so stubborn sometimes!"
    scene bg cafeteria winter
    ...
    S @ frown talk "Were you even listening during the lecture?"
    ...
    C @ neutral talk "Sorry. I kinda zoned out."
    S frown "You've been kinda spacey lately, Clover. Are you sure you're alright?"
    ...
    S neutral "The abstract for the experiment should go over the basics. Please read through it while I sort these out."
    ...
    C surprised "What's a \"tit-ration\"."
    S @ frown talk blush "{b}Titration{/b}."
    ...
    S neutral talk "\"Titration\" is the process of determining the concentration of a substance in a solution by reacting it with a solution of known concentration."
    S "For the purposes of our lab, we are going to first note the change of color as we add the \"titrant\"."
    C smile "(Tit-rant.)"
    "I must be feeling extras stupid today. Every since discovering how I feel about Sibyl, she's just about all I can think about."
    ...
    C @ happy talk "(She's doing it again!)"
    ...
    S neutral "There we go! Would you like to do the honors, Clover?"
    C neutral "Huh? Oh, sure..."
    ...
    C @ neutral talk "Remind me again how I should do this part?"
    S @ neutral talk "Just one drop at time from the pipette. I'll tell you when to stop."
    ...
    S smile "With this, we can do a small calculation to estimate the concentration difference and plot a titration curve!"
    C smile "Sibyl, you're a genius!"
    ...
    show sibyl neutral at mright
    with dd
    S @ neutral talk "Would you like to review my work, Clover?"
    ...
    S @ frown talk "You don't know anything about that book, do you?"
    C contemplative "Well the... girl on the cover kind of looks like you, doesn't she?"
    S neutral "That novel is about a girl who suddenly becomes an orphan and all the terrible misfortunes that it brings."
    C surprised "O-Oh sorry, I didn't realize..."
    show clover neutral with dd
    ...
    S contemplative "I'm fine with it, you know? Being an orphan, I mean. My foster families have always been kind and welcoming."
    ...
    S smile "Take comfort in the knowledge that I am doing well just the way I am. I have a big future ahead of me and lots of plans, so don't you worry."
    "Seeing Sibyl cheer up goes a long way to helping me shake off the awkwardness of my blunder just moments before."
    C @ neutral talk "What sort of plans do you have, Sibyl? Are you going to be an award-winning author? Or maybe some kind of famous artist?"
    ...
    S @ smile talk "I do not believe I am skilled enough for any of that."
    C happy talk "You're skilled enough! You're way skilled enough!"
    ...
    show clover neutral with dd
    S @ smile talk "What I mean is that I want to be a mother. Some day I am going to have a big, happy family, and I'll be the best mother in the world."
    ...
    C smile "You'll be the best foster mother ever, I'm sure of it."
    ...
    S @ smile talk "Clover, you will always be my friend. No matter what happens, know that I will {b}always{/b} be here for you. I hope I can count on the same from you."
    "In the moment, I can only pray she doesn't feel my hand tremble when she says the word \"friend\"."
    C @ tired "(Yeah, I want to be her friend. I want to be her {b}girl{/b}friend!)"
    ...
    C smile "Of course, Sibyl. You're my best friend in the world."
    ...
    "The only conclusion that I arrive at is that I will have to resort to the one thing I most wish I would not have to if I'm going to be serious about making Sibyl return my feelings."
    stop music fadeout 0.5
    jump beg_twins
...
label beg_twins:
    ...
    C @ tired "(You need their help, Clover. You can't do it alone.)"
    ...
    C frown "I need your help with Sibyl."
    ...
    C anxious "Go ahead and have your fun at my expense. I'm desperate, okay?"
    scene bg meeting winter
    show clover neutral at mleft
    show vinci alt neutral at center
    show vitti alt neutral at mright
    with dd
    "Finding me no longer pushing back against them, the set of twins return to a more relaxed posture, each taking their seat around the big table. I find a seat of my own, glad to have them finally back off."
    O @ alt neutral talk "Well, what have you tried?"
    ...
    C contemplative "I'm pretty new at this whole love business so I did some research on the Internet and tried to use what I learned on Sibyl."
    H @ alt neutral talk "Sibyl does not seem the type to respond well to pick up lines."
    "I'm a little surprised at how rationally Vittoria is listening to me. It occurs to me that it's quite possible that the way I have reacted to their teasing in the past only encourages she and her sister to act out further."
    C @ neutral talk "No, not pick up lines. I mean, like, the basics — paying her compliments, taking an interest in her life, introducing small touches into our everyday exchanges."
    H alt smile "A decent start..."
    O @ neutral talk "How has she responded?"
    C neutral talk "Well... normally at first. She would just laugh it off like always when I would say something dumb."
    C frown talk "But now, more recently, Sibyl just gives me a polite reply and goes on with what she is doing like it never even happened."
    show clover neutral at mleft
    show vinci alt neutral at center
    show vitti alt neutral at mright
    with dd
    "The twins look toward each other in quiet communication, then back toward me."
    O @ alt neutral talk "At some point, Clover, you will have to give up."
    C @ neutral talk "B-But...! Don't you have a magic technique or other some sure-fire way to win her over? I mean, you're both doing it all the time with other students here!"
    H @ alt neutral talk "We are not witches, Clover. There is no magic love potion."
    O @ alt neutral talk "If she is not at all receptive to your advances, then there is simply nothing to be done about it."
    C shout "No! I refuse to accept that."
    ...
    C anxious "Isn't there {b}anything{/b} you can do?"
    ...
    C scowl "You want me to... grovel on my knees before you and kiss your shoes!?"
    O @ smile talk "A delightful notion, isn't it?"
    ...
    C @ shout "Ugh!"
    "Vincenza must know that for a stubborn and proud girl like me this is most truly the worst possible thing she could ask, and so here she is asking for me to willingly have my dignity debased before them."
    ...
    H @ smile talk "What is it you want our help with, dear?"
    O @ smile talk "I think you'd missed a spot."
    "They're toying with me again, I know it, but there's nothing left for me but to play along."
    "Vincenza holds her hand down toward me, displaying to me her fancy gold pinky ring. He sister does the same with an identical ring on her hand. For a moment I don't understand at all, but the same of metal on my lips is the answer."
    C @ shout "Please, Vincenza and Vittoria, I beg you to help me make Sibyl fall in love with me! I am utterly hopeless without your assistance!"
    H alt smile "Very good!"
    O alt smile "Thank you."
    ...
    H @ neutral talk "We are women of our words, Clover."
    O @ neutral talk "I promise that Vittoria and I, as well as some of our choice associates..."
    show vinci alt awkward
    show vitti alt contemplative2
    with dd
    "There's a pause where the two glance to each other again, clearly already formulating plans between them already."
    O alt neutral talk "...Will do what we can to help you. Keep in mind that all we can do is give you and Sibyl a little push."
    H alt neutral talk "The rest is up to you. You must be willing to give it your all."
    C deer "I am!"
    O neutral talk "Be confident. Push yourself onto her if you have to, but also hold back when appropriate."
    H neutral talk "Use your wiles. {b}All{/b} of them. Maybe hike your skirt up a little; it can't hurt."
...
label aqua_date:
    ...
    show clover smile at mright
    with dissolve
    S @ neutral talk "You don't have to come with me, Clover. They said it's a two person job but I can handle a few fish by myself."
    C @ happy talk "No, I need a break! I was getting tired of trying to wrap my head around trigonometry anyway."
    ...
    C @ excited "(I can work with this. Come on, Clover, time to strut your stuff!)"
    ...
    C @ happy talk "It's so comfortable! Sibyl, you have to try this!"
    ...
    S @ frown talk "Eww, no thanks. I don't want to know what's soaked into that thing."
    ...
    C surprised "Hey, what are you doing?"
    S @ neutral talk "These candles are a fire hazard."
    ...
    C smile "Maybe leave some lit up for now?"
    ...
    S frown "What's gotten into you, Clover? We're just here to feed the fish."
    show choice_darkness with dissolve
    menu:
        "\"I just... think we shouldn't rush to waste this nice atmosphere, that's all.\"":
            hide choice_darkness with dissolve
            C contemplative "I just... think we shouldn't rush to waste this nice atmosphere, that's all."
            S @ frown talk "Clover, I think they set this all up for their... {b}trysts{/b}."
            ...
            C "You think they really do that sort of thing?"
            S @ frown talk "Well, I don't know exactly. Vittoria and Vincenza are super helpful and totally sweet when they want to be, but I try to distance myself from their other \"peculiarities\"."
            show clover frown with dd
            "The excitement inside my suddenly douses like the candles Sibyl is wont to snuff."
            C @ frown talk "You mean because they're... gay?"
            "The lights flick on to dispel the atmosphere again after Sibyl brushes past me to end the mood once and for all."
            S neutral "It's not be because they're gay. I just think two people shouldn't do that unless they're in love."
            show clover smile with dd
            "Instantly, my soul is revived."
            C @ happy talk "I get what you mean! I think doing \"that\" with the person you're in love with would be amazing!"
        ...
        "\"I'm all hyped up from lacrosse practice this morning.\"":
            ...
            C contemplative "...I got, like, so jittery and excited from that, and now that I'm free from the trigonometry all the energy is coming back again."
            S neutral talk "I'm happy you're enjoying lacrosse, Clover. Have you been getting along well with Tanya?"
            C @ frown "(Why is she talking about Tanya at a time like this? Can't you see that we're having a moment?)"
            ...
            C neutral talk "Yeah. She's pretty good at lacrosse and I've learned a lot."
            show clover neutral with dd
            "Honestly, we barely interact except when we meet on the field during our practice games, and those times we're both trying to wrack each other with our stick more than talk."
            S @ smile talk "That's great news! I think the two of you could be best friends if you both give it a try."
    ...
    show sibyl smile
    show clover neutral with dd
    C @ happy talk "The music is pretty good, isn't it? Want to dance?"
    "Sibyl just smiles at me softly, then takes her hands back from mine."
    S neutral talk "You're three months too late for the masquerade ball, Clover."
    "Just like that, the whole evening is wasted. I give it my all and Sibyl shuts me down every single time."
    C contemplative "(Is she just dense or what? Do I have to come right out and say it? Should I have? Did I miss my chance?)"
    scene bg bedroom with dissolve
...
label tanya_trouble:
    ...
    T neutral talk alt2 "Stop making a scene. I just want to talk. Somewhere private."
    ...
    "It's a surprise to me that the twins told Tanya about this at all, let alone after less than a day, but as I think back I never did tell them to keep it a secret. That should have been understood."
    ...
    T scowl alt2 "First of all, because she's never going to return your feelings and all you're doing is troubling her, and secondly, because I—"
    ...
    T scowl "Yes, exactly, I'm trying to make you give up on her. {b}I{/b} already gave up on her and am content to stay her best friend."
    show clover neutral with dd
    ...
    C contemplative "What was that?"
    T frown talk "Nothing. You're absolutely infuriating in every way, you know that?"
    ...
    C neutral talk "I'm not giving up on Sibyl, Tanya, but I do appreciate how much you care about her. I promise that I would never do anything to hurt her."
    show clover neutral
    show tanya neutral
    with dd
    ...
    C shout "Shut up!"
    T scowl alt2 "So what now? We agree to disagree, and I come back to beat your ass when you eventually make Sibyl cry?"
    ...
    T contemplative alt2 "What do you even love about her anyway? You've known her for all of a month."
    C neutral talk blush "Well, she's totally amazing at everything, isn't she? She's kind, and playful, and..."
    T frown talk "And what? Lots of people are kind and playful."
    show tanya frown with dd
    C tired "(Why {b}do{/b} I love Sibyl?)"
    ...
    C contemplative blush "Well she's super gorgeous. Her hair seems to shimmer in the sunlight, and at the same time her eyes sparkle like bright blue sapphires—"
    T frown talk "Aquamarine."
    C surprised "What?"
    T neutral talk alt2 "Sapphires are dark blue. Aquamarine are light blue, like Sibyl's eyes."
    show tanya neutral with dd
    C contemplative blush "Huh, yeah... aquamarine."
    ...
    C deer "Wait, no, I'm totally serious about Sibyl, for real! It was love at first sight!"
    T shout "There's no such thing as \"love at first sight\", Clover! If you don't actually love Sibyl as a person for real, then I'm going to murder you for real."
    C shout "Well what do {b}you{/b} love about Sibyl then, huh!?"
    show clover scowl
    show tanya contemplative alt2
    with dd
    ...
    T shy blush "Her compassion, deep and limitless. Her freedom, so simple and joyous."
    show clover surprised with dd
    ...
    scene bg cafeteria winter
    show sibyl frown at mright
    show clover neutral at left
    show tanya neutral at mleft
    with dissolve
    ...
    T neutral alt2 "The toilets overflowed."
    C contemplative "...The kitchen line was really long."
    S @ frown talk "Is that all? I'm glad."
...
label libraryflirt:
    play music guitar1
    scene bg library winter with fade
    "A significant portion of Sunday is passed in the library, as has become the routine since I have begun to settle into my life with Sibyl at the academy."
    ...
    with dd
    C @ neutral talk "Hey Sibyl, check this out! Doesn't this couple look so cozy sharing this scarf?"
    ...
    S neutral talk "Hmm?"
    "Sibyl's head lifts up from her own teen magazine. This kind of fashionable flirty column is exactly what I can take advantage of to get her attention."
    C @ happy talk "I've never shared a scarf before. Want to try it with me?"
    "With a falsely casual motion to hide my eagerness, I slide the magazine across to Sibyl. Tanya intercepts it instead and pulls the magazine away from Sibyl before she can get a good look."
    T @ neutral talk "Oh, is this the issue with the article about capybaras?"
    S excited "Capybara? Are there pictures!?"
    C surprised "What? No! There's nothing like that in there!"
    show clover neutral
    show sibyl smile talk
    with dd
    ...
    "What Tanya also seems to know is that Sibyl is crazy about capybaras to the point where she passes the next few minutes telling me all about them with Tanya's prompting in between to keep her going."
    C @ neutral blush "(Sibyl is so incredibly cute when she's gushing about capybaras.)"
    ...
    show vinci alt surprised at qright
    show vitti alt surprised at right
    show sibyl neutral
    with dd
    ...
    H frown talk "Oh no, we {b}must{/b} get you to the nurse!"
    O frown talk "But, sister, I must return this book today!"
    ...
    S @ frown talk "Aren't you going to help her, Tanya? She's your friend!"
    T surprised "But...!"
    ...
    C impish "(Better luck next time, Tanya!)"
    "I give her a smile flush with the thrill of victory, then pile on the train right after Sibyl."
    C anxious "You'd be best to help her, Tanya. You can support her with that chunky lacrosse body you have."
    T shout "{b}Ch-Chunky!?{/b}"
    ...
    O @ alt surprised "Ow, ouch!"
    S @ angry "{b}Tanya!{/b}"
    T frown talk "O-Okay, okay, come here!"
    ...
    C contemplative "So this is what Vincenza likes to read?"
    ...
    S "{i}Little Women{/i}."
    C neutral "What's it about?"
    S contemplative "I have yet to read it, but I know it is about the lives of four sisters."
    ...
    menu:
        "\"Tell her there's something on her cheek then...\"":
            ...
            C @ neutral talk "Hey, Sibyl, there's something on your cheek."
            S @ neutral talk "Hmm? What is it?"
            ...
            S @ neutral talk "Did I get it?"
            C @ neutral talk "Not quite. Here, let me..."
            ...
            C @ tired blush "(I hope she doesn't feel how much my hand is shaking.)"
            ...
            C @ neutral talk blush "Not quite. Just a little more..."
            ...
            C @ surprised blush "(Go for it, Clover, you're so close!)"
        ...
        "\"Lightly brush your foot up against her ankle...\"":
            ...
            C @ frown "(Playing hard to get, huh? Fine.)"
            ...
            S @ neutral talk "Do you have to pee, Clover?"
            C surprised "W-What!?"
            S @ neutral talk "You're fidgeting all over."
            C neutral talk "I don't need to pee!"
            S frown talk "You really shouldn't hold it in."
        "\"While she's watching, bite your lower lip...\"":
            ...
            C @ frown blush "(I'll show you something better than that magazine. You can't ignore this!)"
            ...
            S neutral talk "I have some cough drops in my bag, Clover. Let me get you one."
...
label artclassflirt:
    ...
    show izzie smile talk at qmright
    with dd
    mi "She's cute. I can see why you like her."
    C surprised "{b}Hyah!{/b}"
    ...
    mi frown talk "Oops, you're going to have to start over on that one."
    C frown "Huh?"
    mi neutral "Your little doggie. The layers are all off after the table was bumped, see?"
    ...
    C @ tired "(Vittoria and Vincenza seriously told our art teacher of all people? It's bad enough that Tanya knows!)"
    ...
    C neutral talk "You can't tell anyone!"
    ...
    mi @ smile talk "So anyway, a charming pair of birdies flew in recently and told me that you needed some help catching a pretty peacock."
    C contemplative blush "I... uhh..."
    ...
    scene bg artroom winter
    show tanya frown alt2 at qleft
    show sibyl smile at qmleft
    show izzie smile at qmright
    show clover neutral at qright
    with dd
    T @ frown talk alt2 "I fail to see why she can't just do this with anyone else, Miss Izzie."
    ...
    S @ smile talk "I can take it from here, Miss Izzie."
    ...
    scene bg artroom winter
    show tanya scowl alt2 at mleft
    ...
    "There's no way I would have forgotten the nude drawing Sibyl made of me so soon after meeting her. It was strange at the time, but now I'd gladly strip everything right off to model for her."
    "My reply comes out with a modest \"yes\" without needing to tell her about all the rest."
    S smile "Miss Izzie thinks it's a good opportunity to translate the same subject into a tactile medium."
    C @ neutral talk blush "Tactile...?"
    ...
    T smile "I'm totally fine with it though! I know how to model properly, unlike Clover."
    ...
    S neutral "Are you sure? if you really don't want to I'll just have Tanya—"
    C "I want to do it!"
    hide sibyl
    show clover neutral
    with dd
    ...
    T @ shout alt2 "I'm seriously going to murder you."
    ...
    with dd
    C contemplative blush "S-So do you want me to... s-strip here, or...?"
    ...
    S smile "No, I mean a sculpture bust. That's just your shoulder on up. You won't need to take anything off at all."
    ...
    S frown "Yes, you're right, but... hmm, I just don't know where to start."
    ...
    S neutral talk "Are you alright?"
    C neutral "Sorry, your fingers are just a little cold."
    S neutral "You do feel warm."
    ...
    C neutral blush "(Is she going to mold the clay or mold my face?)"
    ...
    C @ tired blush "(It was a good idea at least even if it didn't work out as I had hoped, Miss Izzie.)"
    ...
    C surprised blush "(Her lips!)"
    "Right before me, that soft pink pout. I could lean just a little bit closer and touch her lips with my own."
    C contemplative blush "(Should I kiss her? Would she freak out? Can I play it off an an accident?)"
    ...
    C deer blush "(I'm going to kiss her, and then play it off real smooth... or maybe I should just tell her I love her right now?)"
    ...
    show tanya scowl alt2 at right
    ...
    hide izzie
    with dd
    S @ smile talk "I'm almost done the basic shape of the head and shoulders. How are you holding up, Clover?"
    C @ neutral talk blush "Oh, umm, pretty good. Thanks."
    ...
    C "(Maybe I've been a little naive in thinking that all I need to do is surround her with my affection and she would automatically fall in love with me.)"
...
label cloverdecorations:
    ...
    "Somehow, the feeling doesn't extend to Sibyl, who is always caught up in doing something or another during her free time. While Sibyl's activities might not be totally to my interest, she herself is, so I follow along with her every time."
    ...
    S @ smile talk "Because Ms. Woolsey entrusted the task to us."
    ...
    S @ frown talk "And because you looked even more bored than normal today. I thought it best to get you out of your bed before your body melds into it fully."
    "Sibyl has a point, though I do not want to admit it. When Sibyl chooses to remain in our room to read her novels, I'm left to molder in my bed the whole time."
    S neutral talk "Okay, next shamrock, please!"
    ...
    S smile "Maybe you should join another club!"
    ...
    S neutral "How did that in there?"
    C contemplative "Hmm?"
    ...
    C deer blush "(Confidence! I need to show Sibyl I want her to be mine!)"
    show sibyl surprised blush
    show clover surprised blush
    with dd
    ...
    S contemplative blush "Clover...?"
    show clover deer blush with dd
    ...
    C surprised blush "B-Because it's a m-mistletoe... we k-kiss..."
    "I was aiming for the lips, but maybe it's actually better that Sibyl moved enough that I kissed her on the cheek. I wouldn't have been able to come back from it otherwise."
    ...
    stop music fadeout 0.5
    show naomi surprised at qmright with dd
    mw "Got you!"
    show clover teary blush with dd
    ...
    mw sad talk "Clover. You need to calm down."
    ...
    scene bg kotatsu
    show clover distraught blush at qmleft
    show naomi frown at qmright
    with dissolve
    play music sad
    ...
    mw @ sad talk "How are you feeling, Clover?"
    "As not-all-right feeling as I am, Ms. Woolsey isn't looking all that much better. She's trying to hide it under a caring guise, but I can tell immediately how freaked out she is underneath her calmness."
    mw @ sad talk "Can I get you anything?"
    show clover teary blush with dd
    ...
    mw @ sad talk "Would you like to tell me what happened?"
    C distraught blush "N-No..."
    ...
    C teary blush "(Maybe I overreacted... a tiny bit.)"
    stop music fadeout 0.5
    play music guitar2
    ...
    C "(Sibyl won't hate me for it. No, Sibyl is probably just as freaked out as I am. She might not even know why I tried to kiss her.)"
    "I say it over and over again in my head, which makes me feel a little lighter yet also somehow hollow inside."
    C @ anxious "You purposely put the mistletoe in the shamrock box, didn't you?"
    mw awkward "The twins asked me to help with— well, you know."
    C @ scowl blush "(Is there anyone those twins haven't told? Does the whole darn school board know by now!?)"
    mw sad talk "I'm so sorry, Clover. I didn't think anything like this—!"
    ...
    C frown talk "Listen, umm... I'm fine now."
    C anxiety "And, uhh, it's all my fault. It was me who royally screwed up, so you definitely shouldn't apologize for my own freak out."
    ...
    C contemplative "(Where am I anyway?)"
    ...
    mw @ neutral talk "We'd better get you back to your room. Sibyl is probably having a tough time with this too."
    ...
    C anxious "What do you think I should do, Ms. Woolsey?"
    ...
    mw pensive "That's a... good question."
    C "(She's clueless. She's probably never even had a lover before, I mean, she's a {b}gym teacher{/b}.)"
    scene bg kotatsu with dd
    play sound doorslam
    "Just as my mind starts to conjure possible events which could have led to Ms. Woolsey's life having gone so horribly wrong so quickly, the door to the manga library swings open and shut beside us."
    show naomi surprised at mleft
    ...
    if secret_lilies_romance == "blanche":
        ...
        mi @ smile talk "Calm down, Nao-chan, I'm just messing with you."
        mw neutral "I know you are, Izzie, but Blanche might not, and she has a lot going on right now without worrying over me."
        ...
        mi excited "If I text Veronika and get her permission, would you let me?"
        mw surprised "Wait, no, Izzie, stop! Veronika gets {b}really{/b} protective over my breasts!"
        ...
        C contemplative "(Well she is the athletics instructor after all, but who is this \"Veronika\" and why does she care about her breasts so much?)"
        ...
        mi smile talk "I'm sorry, you know I just can't stop myself from teasing a maiden in love."
        mw smile "You're the {b}worst{/b}, Izzie."
        "Ms. Woolsey very clearly calls Miss Izzie \"the worst\", but smiles brightly as she says it regardless."
    elif secret_lilies_romance == "izzie":
        mi surprised "So the Grand Macaron herself is breaking protocol and bringing one of the uninitiated into our sacred temple."
        show izzie smile with dd
        "Miss Izzie shakes her head disapprovingly despite grinning the whole time."
        mi excited blush "Nao-chan, you bad girl! I'm going to have to punish you {b}thoroughly{/b}."
        mw excited blush "Izziiiie...!"
        show clover contemplative with dd
        "Ms. Woolsey exclaims my art teacher's name with a hushed but drawn out whine, and a bright red blush across her face too. She covers my ears with her hands as she shushes Miss Izzie, though I can still hear everything through them."
    ...
    show izzie neutral
    with dd
    mi @ neutral talk "So what's up with Clover?"
    ...
    mi @ neutral talk "See, this is why straight girls are the worst."
    mw @ sad talk "Izzie, {b}please{/b} try to have some tact. Clover's in a lot of pain and terribly confused right now."
    mi @ neutral talk "Sorry, Clover. So you want to know how you should play it, huh?"
    "I nod simply, figuring that if anyone beside the twins would have experience here, it might be Miss Izzie."
    mw pensive "If only Elodie were here. She always knows exactly what to do."
    mi excited "Didn't you hear? She's coming to the meeting this Saturday. Apparently Prudie guilt tripped her into showing up at least once month."
    show naomi excited with dd
    ...
    show izzie neutral
    with dd
    C anxious "Maybe I should just... play it off as a joke. I mean, she's used to me acting like a freak already, so..."
    mw @ neutral talk "You could do that, but it won't help you get any closer to her."
    C vulnerable "I know, but... after freaking out as much as I did when I thought I'd lost her for good, I feel like I'd rather stay by Sibyl's side as her friend forever than lose her if I push too hard."
    mi surprised "{b}No!{/b}"
    ...
    mw frown "Clover has to decide this for herself."
    C contemplative "(Well Miss Izzie obviously thinks I should just go for broke and tell her I love her, but what does Ms. Woolsey think?)"
    mw neutral talk "You've tried everything you possibly could already, haven't you, Clover? Perhaps it really would be best to confess to her directly."
    mw pensive "I won't lie and say you shouldn't be prepared for some painful moment if you do choose to follow that path, but I've seen how much pain you're in already now."
    mw frown "If she accepts your feelings then everything worked out perfectly, and if she can't then you can be at peace knowing you gave it your best try."
    ...
    show clover happy talk at qmleft
    show naomi neutral at qmright
    with dd
...
label failed_confession:
    ...
    C vulnerable blush "I'm sorry about what I did while we were placing shamrocks. It's just that... I-I love you."
    show sibyl frown with dd
    ...
    show clover vulnerable at mright
    with dd
...
label heart2heart:
    ...
    C deer "(I'm dead, for real this time. Tanya has come to make good on her promise to murder me.)"
    scene bg bedroom
    show clover deer at mright
    show tanya scowl at center
    show sibyl bashful at mleft
    with dd
    "Entering the room reluctantly after her is Sibyl, who stands limply with an arm securely captured by Tanya like she put up a struggle and ultimately surrendered to her much stronger friend."
    T @ shout "Do you see this? Sibyl hasn't been right all morning."
    scene bg bedroom
    show clover deer at mright
    show tanya scowl at mleft
    show sibyl bashful at center
    with dd
    ...
    T scowl alt2 "I know this is your fault, so fix it."
    show clover vulnerable with dd
    ...
    C @ tired "(What do I even say to fix this?)"
    "Sibyl's already placed right before me, making it so I can't even look up without seeing her. All I can do is examine closely the state of the floors in the corner of the room."
    ...
    S neutral talk "M-Maybe what we need is a nice big lunch to—"
    ...
    show sibyl neutral with dd
    T @ shout alt2 "Apologize to her, Clover!"
    show clover scowl with dd
    "It's actually kind of aggravating how controlling Tanya is being to Sibyl, both physically and emotionally. I can take her abuse myself but it's different when she's acting this way toward my Vertu."
    C @ shout "Get your hands off her!"
    ...
    C @ shout "I hate her."
    play music sad
    S @ frown talk "She's just worried about me. About both of us."
    C neutral "So she shows her concern by dragging you here against your will? And what about all that shoving you around?"
    ...
    S neutral "Tanya's a good girl. She my have a strong will but also a gentle soul."
    ...
    S @ neutral talk "If you both would stop trying to fight each other, you might notice how alike you both are."
    C @ neutral talk "You keep saying that, but I'm nothing like Tanya."
    S annoyed "You both can be incredibly obstinate, for starters."
    ...
    C contemplative "Okay, fine, we're both terrible then. And I'm sorry."
    S frown talk "You should apologize to Tanya, not to me."
    C neutral talk "I'm not apologizing to Tanya, I'm apologizing to {b}you{/b} for— kissing you..."
    show clover neutral
    show sibyl neutral
    with dd
    "The air suddenly goes quiet between us again, the elephant having suddenly been planted smack dab between us again."
    S bashful blush "So you... \"love\" me?"
    ...
    C bangs blush "Y-Yeah..."
    S frown "But... why?"
    "The question surprises me not in the query, but how frustrated she seems as she asks it. It almost sounds to be rhetorical."
    C contemplative blush "You're really cute, and... you're so patient with irritating people like me and Tanya."
    S @ frown talk "But I'm not gay, Clover!"
    C anxious "I-I... umm..."
    ...
    S contemplative "I... I knew you liked me that way, okay?"
    C "You... what?"
    S frown talk "I'm sorry. I already suspected you had these feelings for me, but didn't know how to react. Maybe I hoped I could ignore it until it went away."
    C surprised "(So I went through all the trouble to try to seduce her and she was purposely ignoring it the whole time!?)"
    ...
    show sibyl frown
    with dd
    "It's with a dark humor that I feel like we're both two rotten peas in a rotten pod."
    C @ frown talk "I'm sorry too. I never meant to burden you with all this emotional torment over my own stupid, clumsy feelings. I really messed up too, thinking that maybe if I pushed just a little harder you might fall for me eventually."
    S @ frown talk "I'm straight, Clover. There's nothing you or I can do to change that. Besides, I've told you about my plans for the future and I mean to make them come true."
    "Sibyl's \"plans\" — children of her own, a big foster family cottage, and all that stuff she spoke to me so dreamily about in the library."
    C @ frown talk "Why can't those plans be with someone like me? Someone like... you know, a woman?"
    "One one level I know there's a very realistic reason that her plans cannot be with a woman."
    "But on another level, I just cannot stand that something as dumb as being born with the same fleshy parts should stand in the way of my honest feelings now."
    ...
    S @ frown talk "You're my Vertu partner and my {b}friend{/b}, Clover, so it pains me to ask this of you, but..."
    S neutral "Please give up on me. It's what's best for both of us."
    ...
    C "(Does she expect me to just... stop loving her that easily? Or is she asking me to bury it deep down until it dies like Tanya?)"
    C frown talk "You're right. That's a terrible thing to ask of me."
    S frown talk "Clover, I'm sorry that—"
    ...
    C neutral talk "So I'm going to ask something terrible of you too. I want you to kiss me."
    show sibyl neutral
    show clover neutral
    with dd
    "I can barely believe I'm saying it, but I do. I don't know whether it's a vindictive request or merely my selfishness coming to the fore again."
    C @ neutral talk "That's the proof of what we're both saying, isn't it? If you find you like it, then that proves your future can include a girl like me. And if not..."
    ...
    "It honestly feels like this has to be some kind of cruel set-up, but there she waits before me blushing softly with a serious yet awkward expression stuck on her face."
    ...
    C contemplative blush "Have you... done this before?"
    S neutral talk blush "You mean kiss?"
    "I nod silently to the question, in response to which Sibyl shyly turns her head away."
    S bashful blush "Yeah, I have."
    ...
    S contemplative blush "It's just a kiss."
    ...
    "I spare not a single thought in taking the request back, though, however guilty I may feel."
    S neutral talk blush "Well...?"
    ...
    C anxious blush "You moved away—!"
    S angry blush "You {b}lunged{/b} at me!"
    ...
    "I want the kiss to last a lifetime. A desperate need to sink deeper into Sibyl wells up inside me. I lean forward to return the kiss with as much confidence as I can muster, but as I do Sibyl's body yields back in return."
    "Her hand leaves my cheek to brace against my chest, keeping me from falling atop her as she pulls away, and my eyes flutter open lazily in accordance with the lightness flooding through my body."
    C "Wow..."
    ...
    show sibyl frown blush at qmleft
    with dissolve
    S neutral blush "I'm sorry, Clover."
    "She smiles, but it's a sad smile befitting someone who has to break bad news to a friend."
    "The meaning is clear. Sibyl did not feel a thing from our kiss. It was only me melting into sweet ecstasy at the touch of our lips."
    C tired blush "(So that's it then. It's all over.)"
    play sound bedcreak
    ...
    S @ neutral talk "I'll bring you back some churros. I know you love them."
    scene bg bedroom with dd
...
label rebound:
    ...
    with dd
    H @ alt smile talk "So you're already on speaking terms with your Vertu again. {i}Brava!{/i}"
    O @ alt smile talk "We feared the worst when we learned that you haven't been to any of your classes."
    C shout "What are you two doing here and how did you get into my room?"
    hide clover with dd
    "With no small amount of annoyance do I note how neither answers my latter question when they encircle me, and so I decide to roll myself up into the safety of my sheets once more."
    C "Go away!"
    "The feeling of two heavy weights depressing down the bottom of my bed indicates that neither has left me as I had demanded of them."
    H alt vulnerable "Is that any way to greet your thoughtful student council representatives when they come to check up on you?"
    C "La-la-la I'm not listening. Everything you say ends up making my life worse."
    "There's no doubt in my mind that the twins are in some way aware of what recently happened between me and Sibyl, and I'm not about to let either of them ruin my mood further."
    O alt frown talk "She says she's not listening, Vittoria. What do we do now?"
    H alt smile talk "I propose that we have our way with her, Vincenza."
    "I quiver in my cocoon of sheets. This shelter has always felt so safe and secure before, but it's also never been tested against this level of danger."
    C "Don't touch me!"
    H smile talk "Was that a reply just now, dearest sister?"
    O smile talk "Certainly not. Clover is, after all, completely unable to hear us."
    C "I wasn't replying. That was a totally random warning to stay away from me."
    O awkward "Now that most certainly sounded like a reply, but no— I must be imaging it, for cotton is soundproof."
    H excited "It matters not. So long as Clover remains in her impenetrable bubble, we are free to play with Sibyl to our hearts' des—"
    C shout blush "{b}Don't you dare touch her!{/b}"
    ...
    with dd
    O @ alt smile talk "Relax, Clover, we are only teasing you."
    show clover scowl with dd
    "Neither twins looks particularly surprised by my sudden reveal, much to my dismay. They both remain infuriatingly calm and collected at the bottom of my bed, smug expressions plastered on their faces."
    H @ alt smile talk "We are merely here to look after you, honestly."
    show clover frown with dd
    "I flop back down sluggishly onto my bed facing the twins, relaxed but not off guard."
    C @ frown talk "What does it matter to you? Haven't you done enough already?"
    H @ alt neutral talk "Is it not the president's duty to look after the well-being of her charges?"
    O @ alt awkward "...And perhaps we do feel a touch responsible for how events unfolded."
    show clover scowl with dd
    "I can practically feel the frown on my face further reduce into a scowl as I stare down the twins in silence."
    C @ neutral talk "So you going to apologize?"
    show vitti contemplative2
    ...
    O alt neutral talk "We are sorry for how things turned out, Clover."
    H alt neutral talk "We should not have encouraged you while knowing this would likely be the result."
    show clover neutral
    show vinci alt neutral
    show vitti alt neutral
    with dd
    ...
    C anxious "...Tell me how to get over my feelings for Sibyl."
    "However intense the emotional turmoil was to start with, I have come to accept that I must go back to being simply Sibyl's friend and roommate."
    "Just because I accept this conclusion, however, does not mean everything is now fine and dandy. My heart still feels like a sponge being wrung out every time I look at her or say her name."
    C vulnerable "I know I can't be with her, so I just want these feelings to... {b}go away{/b}."
    ...
    C scowl "Well? After messing around with so many girls you must know everything about curing heartbreak by now."
    show vinci alt neutral
    show vitti alt neutral
    with dd
    ...
    O alt vulnerable "However valid and true your love may be, certain circumstances mean that your feelings may never be accepted."
    ...
    O neutral "This may not sound much like a comfort now, but in time you will find another girl who makes you just as crazy in love as Sibyl did." 
    C anxiety blush "I see Sibyl's face every time I close my eyes. I feel the press of her lips just as vividly as when she was kissing me."
    H alt surprised "Hold up, you kissed her?"
    O alt surprised "{b}She{/b} kissed {b}you{/b}?"
    show clover surprised blush with dd
    "Like a total dunce I spill the beans on my selfish request to Sibyl which she had so selflessly granted despite not liking me in that way."
    C shout blush "You can't tell {b}anyone{/b}, least of all {b}Tanya{/b}."
    ...
    C tired "(At least this means I know I can trust Sibyl to not kiss and tell.)"
    show vinci alt neutral
    show vitti alt neutral
    ...
    show clover neutral with dd
    H @ alt smug "I must applaud you in this endeavor, Clover. You succeeded where Vincenza and I had not."
    ...
    C contemplative blush "Maybe it would have been better if I hadn't gotten to kiss her? Sibyl is all I think about to the point where I just can't think clearly anymore."
    H @ neutral talk "Have you tried schlicking it out? You might feel better after."
    ...
    O @ alt smile talk "\"Petting the kitty\"?"
    H @ alt smile talk "\"Rehearsing finger puppets\"?"
    O @ alt smile talk "\"Whipping cream\"?"
    H @ alt smile talk "\"Taking a selfie\"?"
    O @ alt smile talk "\"Buffing the hood ornament\"?"
    H @ alt smile talk "\"Polishing the pearl\"?"
    O @ alt smile talk "\"Flipping the downstairs breaker\"?"
    H @ alt smile talk "\"Partaking in Taco Tuesday\"?"
    O @ alt smile talk "\"Swirling the eddy\"?"
    H @ alt smile talk "\"Getting rug burn\"?"
    O @ alt smile talk "\"Giving yourself the finger\"?"
    H @ alt smile talk "\"Strumming your banjo\"?"
    O @ alt smile talk "\"Stroking your ego\"?"
    H @ alt smile talk "\"Snorkeling the Venusian abyss\"?"
    O @ alt smile talk "\"Taking the self-guided tour\"?"
    H @ alt smile talk "\"Churning fresh butter\"?"
    O @ alt smile talk "\"Beating under the bush\"?"
    H @ alt smile talk "\"Celebrating Palm Sunday\"?"
    O @ alt smile talk "\"Flooding the basement\"?"
    stop music fadeout 0.5
    C shout "{b}STOP!{/b}"
    show vinci alt neutral
    show vitti alt neutral
    ...
    C vulnerable blush "I know what you're getting at, and I— I tried it, but Sibyl was still looming above everything else in my mind the whole time."
    play music guitar1
    ...
    H @ neutral talk "That's called a \"rebound\", Clover, and jumping in bed with another girl while you're still emotionally vulnerable is very bad."
    C scowl "But you said I should move on and find someone else!"
    O @ neutral talk "We did say so, but we meant after you fully come to terms with how things ended with Sibyl and are ready to move on."
    C anxious "But you said I'd never get over Sibyl."
    ...
    C @ shout "I take back everything I told you before. Permission to touch: granted."
    show vinci alt awkward
    ...
    show vitti alt neutral
    with dd
    H @ neutral talk "Are you {b}sure{/b} that you want this, Clover?"
    O @ neutral talk "Is this really how you want your first time to be?"
    ...
    "The now-familiar sensation of lips pressed against my own returns, feeling much like the way Sibyl kissed me but also much more intense than that kiss at the same time."
    ...
    "I want to kiss so much more, and so much more deeply, but Vincenza holds herself back like the maddening tease she and her sister are."
    ...
    "Most importantly, I definitely don't love Vittoria or Vincenza. A part of me fears that what Tanya had said before might actually be true.)"
    ...
    "With the knowledge that classes will surely be letting out sooner rather than later, I shuffle through a shower and get re-dressed to await Sibyl's eventual return."
    play sound doorclose
    show sibyl neutral at mleft
    show clover neutral at mright
    with dd
    S @ neutral talk "Good afternoon, Clover. How are you feeling today?"
    "When Sibyl does eventually come sweeping back through the door to our room, it's with a perhaps contradictory relief that I feel a prickle of thorny pain in my chest upon seeing her cheerful face."
    C happy talk "So much better. Thanks for asking, Sibyl."
    show clover smile with dd
    ...
    S smile talk "That's great! I was worried that I'd have to dump all of this homework on you while you were still in a poor state of mind."
    ...
    S smile talk "But before we start, it's Tex-Mex night in the cafeteria. Let's go grab a couple burritos and some churros to bring back here."
    show clover smile with dd
