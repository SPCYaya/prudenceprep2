label howto:
    ...
    with dd
    "My daydreams all come to an end when my subconscious brain walks me smack dab into the subject of my thoughts, planting me face to face with Sibyl."
    C "Eyeep!"
    ...
    S smile talk "Good morning, Clover! Are you feeling better today?"
    hide sibyl
    show clover neutral at center
    with dd
    "After fending off Sibyl's concerns for my supposed illness and making an excuse for my absence, I sit down at my desk to try to actually do some of that homework which I had blown off the day before."
    ...
    "Having finished her own homework last night while I was in bed pretending to be sick, Sibyl's only care now is sweeping her beautiful blue eyes from side to side as she tears through the lines of her latest novel."
    ...
    C excited "(\"Six Simple Steps\"? Is that all it takes?)"
    ...
    C frown "(Sibyl has it worse than me. She might never have even known her parents.)"
    ...
    menu:
        "\"What's your favorite color?\"":
            ...
            S contemplative talk "Umm, thanks, and... yellow."
        "\"Are you a morning person or a night owl?\"":
            hide choice_darkness with dissolve
            C @ happy talk "Are you a morning person or a night owl?"
            "Everything I've done is a sure win, or so I think initially, but every passing microsecond that Sibyl gives me a strange look like I'm not even speaking English lessens my confidence."
            S contemplative talk "Umm, thanks, and... probably a night owl if had to choose."
        "\"What is your astrological sign?\"":
            hide choice_darkness with dissolve
            C @ happy talk "What is your astrological sign?"
            "Everything I've done is a sure win, or so I think initially, but every passing microsecond that Sibyl gives me a strange look like I'm not even speaking English lessens my confidence."
            S contemplative talk "Umm, thanks, and... Libra."
...
label failed_seduction:
    ...
    C @ happy talk "No. I just felt like sitting next to you today."
    "In truth, I prefer to sit opposite Sibyl where I can enjoy each expression on her face as she converses with Tanya."
    "I have recently taken to cherishing the moments when her cheeks puff up wth laughter or her eyebrows raise high with surprise."
    ...
    "Tanya only just now breaks acknowledges me, though I have caught some glowering glances my direction thus far into our mealtime."
    ...
    C shout "But I want to sit beside Sibyl too!"
    ...
    S @ frown talk "You've been kinda spacey lately, Clover. Are you sure you're alright?"
    ...
    S @ neutral talk "The abstract for the experiment should go over the basics. Please read through it while I sort these out."
    ...
    S @ neutral talk "There we go! Would you like to do the honors, Clover?"
    C neutral talk "Huh? Oh, sure..."
    show clover neutral with dd
    ...
    S @ smile talk "With this, we can do a small calculation to estimate the concentration difference and plot a titration curve!"
    C @ happy talk "Sibyl, you're a genius!"
    ...
    C contemplative talk "Well the... girl on the cover kind of looks like you, doesn't she?"
    show clover contemplative with dd
    S neutral talk "That novel is about a girl who suddenly becomes an orphan and all the terrible misfortunes that it brings."
    show sibyl neutral with dd
    ...
    C @ happy talk "Of course, Sibyl. You're my best friend in the world."
...
label beg_twins:
    ...
    show clover scowl at center
    show vinci smug at mleft
    show vitti smug at mright
    with dissolve
    H @ smile talk "What is this? Has the surly Miss Lovestruck come crawling back?"
    O @ smile talk "Surely this does not bode well at all for her fortunes of the heart."
    "The twins immediately start circling me like vultures when I find them alone together after the end of classes for the day. I just stand there and let them get their teasing out of their systems for a time."
    ...
    C anxious "I need your help with Sibyl."
    ...
    C @ contemplative talk "I'm pretty new at this whole love business, so I did some research on the Internet and tried to use what I learned on Sibyl."
    H @ alt neutral talk "Sibyl does not seem the type to respond well to pick up lines."
    "I'm a little surprised at how rationally Vittoria is listening to me. It occurs to me that it's quite possible that the way I have reacted to their teasing in the past only encourages them both to act out further."
    ...
    H @ alt neutral talk "A decent start..."
    O @ alt neutral talk "How has she responded?"
    ...
    H @ alt contemplative2 talk "We do have certain methods..."
    O alt awkward talk "If you're up to the task..."
    show vinci alt neutral
    show vitti alt neutral
    with dd
    ...
    C @ shout "You want me to... grovel on my knees before you and kiss your shoes!?"
    ...
    H @ smile talk "What is it which you desire our assistance with, dear?"
    O @ smile talk "I believe you missed a spot, Clover."
    "I know they're toying with me again, but there's nothing left for me to do but to play along, even after Vittoria presses the tip of her shoe into my cheek."
    "Vincenza holds her hand down toward me, displaying to me her fancy gold pinky ring. He sister does the same with an identical ring on her hand. For a moment I don't understand at all, but the taste of metal on my lips is the answer."
    ...
    H @ alt smile talk "Very good!"
    O alt smile talk "Thank you."
...
label aqua_date:
    ...
    C excited "(They specifically chose a time that Tanya isn't around too! This cannot be a coincidence.)"
    stop music fadeout 0.5
    play music jazz
    ...
    "I flop right down into it and immediately sink more deeply than I expected into it's legume-stuffed depths, but try to remain cool despite that."
    ...
    C happy talk "Maybe leave some lit up for now?"
    ...
    S @ frown talk "What's gotten into you, Clover? We're just here to feed the fish."
    show choice_darkness with dissolve
    menu:
        "\"I just... think we shouldn't rush to waste this nice atmosphere, that's all.\"":
            hide choice_darkness with dissolve
            C @ contemplative talk "I just... think we shouldn't rush to waste this nice atmosphere, that's all."
            ...
            C neutral talk "You think they really do that sort of thing?"
            show clover neutral with dd
            ...
            S neutral talk "It's not be because they're gay. I just think two people shouldn't do that unless they're in love."
            show clover smile
            show sibyl neutral
            with dd
    ...
    "Just like that, the whole evening is wasted. I gave it my all and Sibyl shut me down every single time."
...
label tanya_trouble:
    ...
    "I feel a sharp tug at my arm just as I hear the words spoken abruptly in my ear. Tanya tugs me so hard I nearly fall flat on my face as I'm pulled out of the line."
    ...
    "The other girls in the line for the chefs stare at us, some more discreetly than others, but everyone in the cafeteria proper can't not see us bickering if they look our way."
    ...
    show clover neutral with dd
    "Tanya keeps saying things forcefully in my direction, nearly backing me against the wall. I make my own attempt at trying to look cool and unbothered despite how irritated she is making me."
    ...
    C contemplative talk blush "Well she's super gorgeous. Her hair seems to shimmer in the sunlight, and at the same time her eyes sparkle like bright blue sapphires—"
    show clover contemplative blush with dd
    T @ neutral talk "Aquamarine."
    C surprised "What?"
    T neutral talk alt2 "Sapphires are dark blue. Aquamarine are light blue, like Sibyl's eyes."
    show tanya neutral alt2 with dd
    C contemplative talk blush "Huh, yeah... aquamarine."
    show clover contemplative blush with dd
    ...
    C surprised "Wait, no, I'm totally serious about Sibyl, for real! It was love at first sight!"
    T shout "There's no such thing as \"love at first sight\", Clover! If you don't actually love Sibyl for real, then I'm going to murder you for real."
    ...
    show clover neutral at qleft
    show tanya neutral at qmleft
    with dissolve
    ...
    T @ neutral talk alt2 "The toilets overflowed."
    C @ neutral talk "...The kitchen line was really long."
    S smile talk "Is that all? I'm glad."
    show sibyl smile with dd
    C @ contemplative "(What did she think was happening?)"
...
label libraryflirt:
    play music guitar1
    scene bg library winter with fade
    "A significant portion of Sunday is passed in the library, as has become the routine since I have settled into my life with Sibyl at the academy."
    ...
    with dd
    C @ happy talk "Hey Sibyl, check this out! Doesn't this couple look so cozy sharing this scarf?"
    ...
    O vulnerable talk "{i}Sto bene{/i}, I am quite fine, just a— {i}ahia{/i}!"
    show vitti frown
    show vinci alt vulnerable
    with dd
    ...
    H frown talk "We {b}must{/b} get you to the infirmary!"
    show vitti frown with dd
    O @ frown talk "But, sister, I must return this book today!"
    H @ frown talk "Sibyl and Clover can handle that, dear sister. We must seek treatment before your ankle swells, right away! Would you help me take her to the nurse, Tanya?"
    hide sibyl
    show tanya surprised at mleft
    with dd
    ...
    "Sibyl remains a little on edge even after Tanya and the royal busybodies take their leave. She looks back toward the door occasionally and I just know in her mind she's thinking about going after them, so I try to distract her."
    C contemplative talk "So this is what Vincenza likes to read?"
    show clover neutral with dd
    ...
    menu:
        "\"Tell her there's something on her cheek then...\"":
            ...
            "I find it simply incredible that Sibyl even carries such a thing given that it's currently the twenty-first century, but she pulls a little clamshell mirror right out of her bag."
            C "You carry a compact?"
            S neutral talk "Not normally, but my skin was a total mess this morning."
            show sibyl neutral with dd
...
label artclassflirt:
    ...
    show clover neutral at center
    with dissolve
    "When the day of the week for art class comes around, I stand in front of the 3D printer watching it slowly build my tiny statue of a puppy layer-by-layer."
    ...
    with dd
    "Behind me, I turn to spot Sibyl and Tanya chatting and laughing together, side by side in front of the easels."
    "I smile softly, eyes locked upon Sibyl's face where her attention vacillates between her paintbrush flicking vibrant hues here and there, and to her friend beside her."
    scene bg artroom winter
    show clover neutral at qmleft
    ...
    "The surprise of being pulled out of the depths of creepily staring across the room at Sibyl leads me to bump up against the 3D printer, totally messing up my little dog sculpture in the process."
    mi frown talk "Oops, you're going to have to start over on that one."
    C frown "Huh?"
    mi neutral talk "Your little doggie. The layers are all off after the table was bumped, see?"
    show izzie neutral
    show clover neutral
    with dd
    ...
    mi @ smile talk "So anyway, a charming pair of birdies flew in recently and told me that you needed some help catching a pretty peahen."
    C contemplative talk blush "I... uhh..."
    show clover contemplative blush with dd
    ...
    scene bg artroom winter
    show tanya frown talk alt2 at qleft
    ...
    S @ smile talk "Miss Izzie thinks it's a good opportunity to translate the same subject into a tactile medium."
    ...
    C neutral talk blush "Sorry, your fingers are just a little cold."
    show clover neutral with dd
    S @ neutral talk "You do feel warm."
    ...
    C surprised blush "(She's so close!)"
    ...
    C anxiety blush "(Is the mood \"right\" now? Should I do it?)"
    ...
    C @ neutral talk "Oh, umm, pretty good. Thanks."
    ...
    C tired "(Maybe I've been a little naive in thinking that all I need to do is surround her with my affection and she would automatically fall in love with me.)"
    scene bg artroom winter with dd
...
label cloverdecorations:
    ...
    "Maybe it's because the frigid throes of winter still have hold over the academy, but every day feels frozen to a standstill."
    "Somehow, the feeling doesn't extend to Sibyl, who is always caught up in doing something or another during her free time."
    "While Sibyl's activities might not be totally to my interest, she herself is, so I follow along with her every time."
    ...
    C "(I... messed up.)"
    play music drama
    "All the blood in my body is once again rushing to my face and I stammer out some nonsense quickly, desperate to get that horrible expression wiped off of Sibyl's face."
    ...
    scene bg kotatsu
    show clover distraught blush at qmright
    ...
    "Everything from my fingers to my toes feels numb, but somehow my body is still shaking all over. My legs tremble and quiver even though absolutely no weight is upon them at all."
    ...
    "Ms. Woolsey sits down beside me on the table to rest her arm across my shoulders. I don't really need the sympathy, but in the desperate state I am in, I find myself unable to shrug it off."
    ...
    C "(Is this manga?)"
    "The inspection of the room soothes my mind a little by distracting the burden of reliving recent events with the colorful covers of all the books which I cannot read."
    ...
    C vulnerable "(She's clueless. She's probably never even had a lover before, I mean, she's a {b}gym teacher{/b}.)"
...
label secretchoice:
    ...
    if secret_lilies_romance == "blanche":
        ...
        mw @ neutral talk "I know you are, Izzie, but Blanche might not, and she has a lot going on right now without worrying over me."
        ...
        show izzie smile with dd
        mw happy talk "You're the {b}worst{/b}, Izzie."
    ...
    C "After freaking out as much as I did when I thought I'd lost her for good, I feel like I'd rather stay by Sibyl's side as her friend forever than lose her if I push too hard."
    show clover vulnerable with dd
    mi surprised "{b}No!{/b}"
    show clover surprised
    show naomi frown
    ...
    mw @ neutral talk "Clover has to decide this for herself."
    ...
    mw pensive "I won't lie and say you shouldn't be prepared for some painful moments if you do choose to follow that path, but I've seen how much pain you're in already now."
    mw sad talk "If she accepts your feelings then everything worked out perfectly, and if she can't then you can be at peace knowing you gave it your best try."
    show naomi frown with dd
    ...
    show sibyl smile with dd
    mw @ happy talk "That's great, Sibyl! Thank you so much!"
    S contemplative talk "Also... Have you seen Clover anywhere?"
    show sibyl contemplative with dd
    mw awkward "As a matter of fact, I have!"
...
label failed_confession:
    ...
    with dd
    "The words are practically spit out of my mouth, and the reaction from Sibyl isn't any too promising. I wait patiently as she remains quiet for a distressingly long time."
    ...
    "The rest of my lame confession is never verbalized. The instant my hand touches Sibyl's, she flinches dramatically in recoil."
    C surprised "..."
    S bashful "..."
...
label heart2heart:
    ...
    hide cpj with dd
    "When the hour hand rolls back around to twelve, I finally toss the sheets off with a mind to stealthily sneak out to fetch some lunch to bring back to my bed."
    ...
    scene bg bedroom
    show clover deer at mleft
    show tanya scowl at center
    show sibyl bashful at mright
    with dd
    ...
    "Sibyl's already placed right before me, making it so I can't even look up without seeing her. All I can do is examine closely the state of the floor in the corner of the room."
    ...
    C neutral talk "So she shows her concern by dragging you here against your will? And what about all that shoving you around?"
    show clover neutral
    show sibyl neutral
    with dd
    ...
    S angry "You both can be incredibly obstinate, for starters."
    show sibyl neutral with dd
    ...
    C @ contemplative talk "Okay, fine, we're both terrible then. And I'm sorry."
    ...
    C bangs talk blush "Y-Yeah... I do."
    ...
    C contemplative talk blush "You're really cute, and... you're so patient with irritating people like me and Tanya."
    show clover contemplative blush with dd
    ...
    S bashful "I'm sorry. I already suspected you had these feelings for me, but didn't know how to react. Maybe I hoped I could ignore it until it went away."
    ...
    "But on another level, I just cannot stand that something as dumb as being born with the same body parts should stand in the way of my honest feelings now."
    ...
    S sleepy "Please give up on me. It's what's best for both of us."
    ...
    "I know that everything I'm saying is total crap, but either because Sibyl only wants to believe in the good side of my intentions or not, she stuns me by accepting the ridiculous proposal."
    stop music fadeout 0.5
    S angry "One kiss."
    show sibyl annoyed with dd
    C surprised "Yeah!"
    ...
    C anxious blush "Have you... done this before?"
    ...
    S contemplative talk blush "It's just a kiss."
    ...
    C deer blush "(I came this far; I can't blow it now!)"
    ...
    with dissolve
    S frown talk blush "I'm sorry, Clover."
    ...
    show clover frown blush
    with dd
    "Sibyl is in much more a hurry to move on from the moment than I am. The awkwardness is clear in her voice despite how well she's trying to hide it."
    "All I can manage to do is shake my head in reply, casting it down instead toward the floor."
...
label rebound:
    ...
    hide clover with dd
    "With no small amount of annoyance do I note how neither answers my questions when they encircle me, and so I decide to roll myself up into the safety of my sheets once more."
    C "Go away!"
    "The feeling of two heavy weights depressing down the bottom of my bed indicates that neither has left me as I have demanded of them."
    H @ alt neutral talk "Is that any way to greet your thoughtful student council representatives when they come to check up on you?"
    ...
    C "I wasn't replying. That was a totally arbitrary warning to stay away from me."
    O awkward talk "Now that most certainly sounded like a reply, but no— I must be imaging it, for cotton is soundproof."
    ...
    show clover shout blush at center with dd
    ...
    O @ alt awkward talk "...And perhaps we do feel a touch responsible for how events unfolded."
    show clover scowl with dd
    "I can practically feel the frown on my face further reduce into a scowl as I stare down the twins in silence."
    C @ scowl talk "So you going to apologize?"
    ...
    show vitti alt neutral
    with dd
    "I accept the twins' apologies wordlessly, though it does not console me any. I even suspect that maybe Ms. Woolsey forced them to do this."
    ...
    C @ anxious "I know I can't be with her, so I just want these feelings to... {b}go away{/b}."
    show vitti alt vulnerable2 blush
    ...
    C shout "Well? After messing around with so many girls you must know everything about curing heartbreak by now."
    show vinci alt neutral
    show vitti alt neutral
    show clover scowl
    with dd
    H @ alt contemplative2 talk "Coquettish flirting and sultry liaisons are merely an amusement to me. Any heartbreak after the fact is not mine."
    ...
    O @ alt smile talk "\"Taking a selfie\"?"
    H @ alt smile talk "\"Buffing the hood ornament\"?"
    O @ alt smile talk "\"Polishing the pearl\"?"
    H @ alt smile talk "\"Flipping the downstairs breaker\"?"
    O @ alt smile talk "\"Partaking in Taco Tuesday\"?"
    H @ alt smile talk "\"Swirling the eddy\"?"
    O @ alt smile talk "\"Getting rug burn\"?"
    H @ alt smile talk "\"Giving yourself the finger\"?"
    ...
    H @ alt smile talk "\"Beating under the bush\"?"
    O @ alt smile talk "\"Celebrating Palm Sunday\"?"
    H @ alt smile talk "\"Flooding the basement\"?"
    stop music fadeout 0.5
    C shout "{b}STOP!{/b}"
    show vinci alt neutral
    show vitti alt neutral
    ...
    C anxious blush "I know what you're getting at, and I— I tried it, but Sibyl was still looming above everything else in my mind the whole time."
    play music guitar1
    ...
    C frown talk "But you said I should move on and find someone else!"
    show clover frown with dd
    O @ alt neutral talk "We did say so, but we meant after you fully come to terms with how things ended with Sibyl and are ready to move on."
    C @ frown talk "But you said I'd never get over Sibyl."
    ...
    "Vincenza correctly guessing that it's my \"first time\" only makes me more annoyed by their current resistance to do what I'm sure they normally would do without a care."
    ...
    "I do not regret the time I shared with Vittoria and Vincenza. They both proved superbly adept at lighting my fire, and were doubly thorough about it too."
    ...
    play sound doorclose
    show sibyl neutral at mleft
    show clover frown blush at mright
    with dd
    S @ neutral talk "Good afternoon, Clover. How are you feeling today?"
    "When Sibyl does eventually come sweeping back through the door to our room, it's with a perhaps contradictory relief that I feel a prickle of thorny pain in my chest upon seeing her pleasant face."
