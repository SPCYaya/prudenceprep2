...
label beg_twins:
    ...
    with dissolve
    H @ smile talk "What is this? Has surly Little Miss Lovestruck come crawling back?"
...
label artclassflirt:
    ...
    S contemplative "Are you sure? if you really don't want to I'll just have Tanya—"
