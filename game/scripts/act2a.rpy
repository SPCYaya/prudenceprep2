...
label heart2heart:
    ...
    "I stare up at the ceiling above my bed for quite a long time but arrive at no solution for how to get out of the academy as fast as possible, and preferably before Sibyl returns."
    ...
    C "I hate her."
    play music sad
    S "She's just worried about me. About both of us."
    C "So she shows her concern  by dragging you here against your will? And what about all that shoving you around?"
    ...
    S "She doesn't mean it, like literally. Tanya wouldn't hurt a fly, unless that fly was picking on another smaller fly, and even then she wouldn't murder the bigger fly."
    ...
    S "You both can be incredibly obstinate."
    ...
    C "I— I'm sorry. I didn't mean that."
    ...
    C "That's the proof of what we're both saying, isn't it? If you find you like it, then that proves your future can include a girl like me. And if not..."
    ...
    scene cg sibylkiss with dissolve
    play music happy
    C "Mm!"
    ...
    play sound bedcreak
    "Her bed creaks softly as she rises from it, but the sound is louder than any emo screamer concert I've ever been to. A million thoughts race through my head but my mind is still lost in the haze of being ripped from such heights to frightening lows."
    S "Would you like to come to lunch with me and Tanya, Clover?"
...
label rebound:
    ...
    "With no small amount of annoyance do I note how neither answers my latter question, and so I decide to roll myself up into the safety of my sheets once more."
    C "Go away!"
    ...
    C "...Tell me how to get over my feelings for Sibyl."
    ...
    O "Your feelings may never fully subside, Clover. You will likely continue to admire all those things which first drew you to Sibyl."
    ...
    C "I know what you're getting at, and I— I tried it, but Sibyl was still looming above everything else in my mind the whole time."
    play music guitar1
    ...
    H "Clover, you are hurting right now, but you shouldn't let that lead you to do anything you're going to regret later."
    ...
    S "That's great! I was worried that I'd have to dump all of this homework on you while you were still in a poor state of mind."
    C "Wait, what?"
    ...
    C "But I haven't even seen the lectures for half this stuff! Will you teach me the material, Sibyl?"
    S "Of course, Clover! What else is a Vertu for if not to lean on in your hour of need?"
