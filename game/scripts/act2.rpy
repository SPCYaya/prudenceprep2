label sibyl_talk:
    ...
    "I resolve to go with a lighter calorie yogurt parfait tomorrow, but for today am satisfied that I need the calories after crying half my water weight out of my eyes the night before."
    ...
    "It occurs to me suddenly and randomly that I could do the same tomorrow with the strawberry atop my yogurt parfait, just like Tanya does every day."
    ...
    "Though I initially felt a considerable amount of anxiety tightening my chest, almost like Abraxas was sitting on my chest as I dialed the numbers, it did not last."
    ...
    "I just couldn't bear to tell my parents that I made {b}no{/b} friends whatsoever after spending my whole time here being a massive nuisance, so I told them all I knew about my roommate."
    ...
    C "I'm... I'm good."
    "The anger and frustration is gone, but something is still off."
    ...
    "The anger might have been banished but there's still a confusing vortex of some strange emotion swirling inside my heart which I have yet to settle into the correct places."
    ...
    S "Then you {b}must{/b} come with me tomorrow evening. I've been meaning to pick up a new novel anyway so it is as good a time as ever."
    ...
    S "Oh, that's right, you are usually busy Saturday evening. Maybe another time then; I'd like to find an activity the three of us can do together."
...
label lacrosse_practice:
    ...
    "As instructed, we gather all around Miss Woolsey. She wheels out a cart full of sticks with nets topping them."
    ...
    "Tanya leaves dragging her feet while at the same time Miss Woolsey steps over smartly to address Sibyl and I."
    ...
    "I know very well it's a total one-eighty from how I was feeling just days before. After all the theatrics of my first night I can barely bear to show my face to Miss Woolsey now."
    ...
    "The ball remains stubbornly in my net despite how much I shake it out in frustration, and ultimately end up smacking myself over the head with my own stick."
    ...
    S "I am not on the team, no, but some of the girls who play lacrosse do split their time with the art club on days when the lacrosse team has no training."
    "I cannot deny that the stick feels pretty good in my hands, but I don't know how I'd compare against actual players."
    C "(And without the major confidence boost from Sibyl's encouragement for that matter.)"
    ...
    C "(She's clearly one of those rich girl types.)"
    S "It's really too bad about her personality though."
    "As supernaturally pretty as Sierra might be, she doesn't capture my attention nearly as much as Sibyl, to whom I find my gaze drawn back toward as naturally as birds fly through the air."
    S "Clover?"
    C "Hmm?"
    ...
    "As I watch the shared laughs and smiles from the sidelines, I now feel every bit of the self-imposed distance that I wished for back when I wanted only to be her roommate."
    jump lunch_sans_tanya

label lunch_sans_tanya:
    show bg transition with fade
    show bg black with dissolve
    "In a dream I run across a wide open grassy field. My hands grasp tightly around a lacrosse stick much like we used in gym class."
    ...
    S "Clover!"
    "One shadowy figure leaps forward to grab at my leg to hold me down and my hopes of making it through diminish into the breeze."
    C "Sibyl, catch!"
    ...
    S "Clover!"
    "It soars through the air toward Sibyl, who remains cheering me with all her might. The evil shadowy figures who hiss at the fruit as it flies over their heads."
    S "Clover!"
    ...
    "I've always have very vivid dreams. I've read before that intense dreams are like a real form of divination but never been able to make any real sense out of them."
    ...
    "I obviously noticed she wasn't hanging around Sibyl as she usually does but hadn't brought it up at all as if Tanya might suddenly appear if I speak her name aloud."
    C "And she just... left you alone after that? Is such a thing possible?"
    S "Tanya {b}always{/b} disappears for hours on Saturday afternoon."
    C "Why?"
...
label a2_library:
    ...
    "Sibyl opens the book and presses her face deeply into pages with a grand sigh."
    ...
    "Reflections there of the bookcases around us only add to the illusion that I can see right through to her mind and peer at all the book she's thinking of at the moment."
    C "(I feel like I could almost see right through to her soul, if only I were able to look deeper in them.)"
    ...
    S "Do I {b}like{/b} it? It all but made me the woman I am today."
    ...
    "We eventually make our way to a table to begin reading our selections. I sit across from Sibyl, who immediately dives right into her book. With equally little fanfare, I do the same."
    ...
    "I watch Sibyl's eyes glide side to side across the pages and note the small inflections of a reaction in her face as she reads, until suddenly her attention suddenly turns to me."
    ...
    "Once we leave the protective silence of the library, Sibyl opens up with eager questions about how well I enjoyed the book she gave me."
    ...
    "I can barely stand to look at Sibyl with how ridiculous and most likely {b}rude{/b} I was being this whole time that I've known her, but she continues on unoffended and instead rather amused."
    ...
    "What was a rather cheerful recollection suddenly turns wistful by the end, but the emotion is fleeting upon her face."
    ...
    "What unsettles me most of all is that someone I've only known for a week should be doing these things to my heart at all."
    jump a2_sunday
...
label a2_sunday:
    ...
    "The thought turns my mood just slightly sour even though I know she has her own life and doesn't need to babysit me, nor do I even want her to."
...
label stop_by_art:
    ...
    "Vittoria sits upright and proper atop Miss Izzie's big desk at the far end of the room while Vincenza stands behind her twin loosely braiding her long silvery hair with idle fascination."
    ...
    "As Sibyl and Miss Izzie make small talk, I am keenly aware of how Vittoria and Vincenza are watching me rather than those speaking."
    ...
    H "Tanya, dearest, if that is what you desire I shall acquiesce without delay."
    ...
    "I feel as though the tension in the room has skyrocketed, but when I glance sideways to Sibyl I do not find any sense of unease about her at all."
    T "Har har, very funny."
    "It's all just my own anxiety."
    ...
    "I'm starting to understand what Tanya wants to do after Sibyl's explanation, and it actually sounds kind of neat."
    ...
    C "(And then when I heard the police started investigating them, I ditched the spray paint in the trash and cowered in my room.)"
...
label choco_making:
    ...
    "The academy kitchens are already abuzz with activity when Sibyl and I arrive. Fortunately, we are able to claim a spot for ourselves among the madness without issue."
    ...
    "Even after watching the others around the kitchen go about their business, I'm already lost at the first step."
    ...
    "I watch Sibyl as she works setting up a duplicate melting bowl for the white wafers. A broad grin is plastered across her face just like the type she wears while concentrating on her art."
    ...
    C "(It's so cute the way her tongue just barely sticks out while she's concentrating so hard on making those tiny little detail touches!)"
    ...
    C "(To think that I was so recently trying everything I could to push Sibyl away... Look at me now!)"
...
label lacrosse_observation:
    ...
    S "The girls on the team are really close with each other. I'm actually kind of jealous when I hear about it with how most of the art club activities are solo projects."
    ...
    "I manage to keep a positive mood on the way to observe the lacrosse team thanks to the sugar still coursing thickly through my veins from lunch."
    ...
    "Sibyl's meek smile is all the confirmation that I need for me to immediately start walking back the way we came."
    ...
    "Both teams are players from Prudence Prep given this is just practice. Every so often players will swap in and out from the bench for each other."
    ...
    S "I've never asked about it but I've always gotten the impression that the two of them were already really good friends despite this being Miss Woolsey's first year teaching here."
    "I try to reconcile what I know about the kind and gentle gym teacher with the oddball arts teacher to find out how they could possibly be friends but come up with no solid answer to the enigma."
    ...
    "I know I have something of a competitive streak, and it comes very much alive within me with the adversity of much my more skilled opponents."
...
label bookreturn:
    ...
    "I've gotten so used to just hovering quietly near Sibyl like an accessory she wears that it feels a little odd to be noticed as real person myself."
    S "I had Clover reading {i}Anne of Green Gables{/i} so maybe you could suggest something for her to read next?"
    st "Your name's Clover? That's so {b}cute{/b}!"
    ...
    "This statement immediately brings a round of giggles from both Sibyl and the library committee girl, whom I suddenly remember Sibyl calling \"Rachel\" when we first arrived."
    ...
    C "(To think that I, as a gloomy goth girl, once thought myself above their kind...)"
    ...
    C "(I think Sibyl is {b}intentionally{/b} leading me to interact more with others.)"
...
label valentines:
    ...
    S "I invite you to do homework with us almost every day, Tanya."
    "The third person, a guest to our room, is part of why everything feels so off."
    "Tanya and I have maintained this weird unspoken \"time-sharing\" thing with regard to Sibyl, where she rarely ever visits us in our room and I mostly stay out of their daytime gossip."
    ...
    "Normally this word-play with my name would make me roll my eyes but from Sibyl I somehow only feel like this is the coolest thing ever."
    ...
    T "When you say it like that you make me sound like a total goof, but that's actually what it means in my culture."
    ...
    "I nod in reply to her opening remarks, waiting patiently for the good part to arrive."
    ...
    "My eyes immediately start searching the bag for the four-leaf \"me\" which leads Sibyl to throw her palms over my eyes and beg for me to stop."
    ...
    C "You can have these, Sibyl. I'm sorry that I didn't realize that Valentine's Day was such a big deal in this school."
    ...
    "I might have a minor heart attack or something because my heart beats all of whack and I remain frozen in place with her hands on mine for longer than I expect."
    ...
    "Tanya's chocolates for Sibyl are enclosed in a small folded paper box which appears to be adorned with charcoal rubbings of various textures."
...
label first_lacrosse:
    ...
    "Sibyl ultimately leaves us both with only her best wishes. I soon find myself walking silently side by side with Tanya down the long hallway to the gym."
    C "..."
    T "..."
    "We both look off the opposite side of one another, unsure what to say."
    "I don't really feel any deep anger or hatred of her but it's still inevitable that we end up butting heads when left together."
    ...
    T "Look, all I mean too say is this: Sibyl is {b}straight{/b}. It's not going to work out for you no matter how hard you try."
    "Now it's my turn to repeat the same \"What?\" that Tanya gave me just before."
    T "{b}Seriously{/b}, Clover. Do you think I haven't noticed how you're always hanging off Sibyl's arm and following her around? How stupid do you think I am?"
    C "I don't know what—"
    ...
    C "(But why tell me at all? I mean, isn't that normal? She doesn't think {b}I{/b} like—?)"
    "The name of my Vertu hangs on the tip of my tongue. It tingles there unspoken, blooming a warmth through my chest completely unlike a crackling bonfire or a thick blanket."
...
label confusion:
    ...
    C "(Oh, she just wants to chat with the new member of the team.)"
    C "Good, I think."
    ...
    mw "Today was just a practice but we have a full season of games with competitor schools ahead of us. Can you see yourself playing against one of our rivals as a {i}Rose{/i}?"
    C "A {b}what{/b}?"
    ...
    mw "You played well, but I couldn't help but think you were distracted."
    ...
    C "(Sibyl!)"
    "The sight of my Vertu partner would normally be pleasant, but just catching a glimpse of her bushy auburn pigtails stops me in my tracks after what Tanya said to me earlier."
    S "There's Clover now!"
    "Sibyl moves from where she is standing chatting with Tanya over to meet me. The latter follows behind without any real change in her usual behavior I can notice."
    ...
    T "She played well when she wasn't tanking blows to the face. We will definitely have her whipped into shape before we play St. Catherine though."
    ...
    C "I-I'm fine! It was just once, and it was just an awkward deflection!"
    ...
    "I'm a little less shaken now than I was before but no close to any answers."
    "I can't deny that Sibyl is special to me now, but it could just be friendship and not... something else."
    ...
    "I know it's not exactly the weekend's fault for being boring, but rather mine for doing whatever Sibyl enjoys rather than pursue my own interests."
    ...
    "My homework, of course, is even more boring than simply doing nothing, so what I do instead is curl up in my bed and mindlessly browse the internet on my smartphone."
    ...
    "While I'm trying to think up the best way to say that I totally slacked off the whole time she was away, Sibyl starts stripping off her dirty uniform on her side of the room."
    ...
    C "(I can't be gay. I mean, I've never really cared so much about any other girls like this.)"
    ...
    C "(That doesn't mean I love Sibyl. She's just my friend and she just happens to be a girl, and I like girls apparently. But that doesn't mean I {b}like{/b} like Sibyl.)"
    ...
    C "K-Kinda... I just need sleep it off. I'll feel way better tomorrow."
    ...
    S "Miss Woolsey told me you were a little spacey at practice. If you aren't feeling well I wouldn't have forced you to go this morning."
