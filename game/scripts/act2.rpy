...
label guidance:
    ...
    "My mind is intent on leaving as quickly as I can until I hear a soft whimper and spot a third student between them."
    ...
    st "E-Excuse me...!"
    "Vittoria and Vincenza both watch my classmates scurry away while beet red to the face, then slowly turn their gazes onto me."
    ...
    O "She was almost there too..."
    H "Such a clam jam."
    "Vittoria produces a fanciful monogrammed handkerchief which she passes to Vincenza, who casually wipes her fingers like it's nothing at all."
    C "Sorry, I-I... I'll just be go—"
    "The twins are on me before I can even finish my excuse to get the hell out of there. Vincenza blocks my escape route with her body, but it's Vittoria whose eyes are locked onto mine with a quiet intensity."
    "I feel her hand touch against my thigh and slide up my tight with a familiar sensation, brushing aside my skirt as she gets all the way up to my hip without any hesitation."
    H "You went and chased her away. I never even got a turn with her."
    "My back finds the wall behind me far too quickly. A seemingly familiar heat swells forth inside me, threatening to burn me up from inside out."
    ...
    C "You're members of the Student Council! The {b}president{/b} even! Shouldn't you be more of a role model for the student body?"
    ...
    C "I mean, you act so proper, Vittoria, when you're anything but. I'd expect this kind of behavior from Vincenza, maybe, since she acts like such a playboy."
    ...
    C "I'm being serious! First you did all of {b}that{/b} to me and then I started having strange thoughts about... you know, {b}those{/b} types of things."
    ...
    "I was all in a funk about being sent to the academy, but when the twins started feeling me up —  it {b}excited{/b} me."
    "I attributed the whole funk I was in to anger and not arousal but my hammering heart and sudden flush of warmth could very well have been caused by both."
    ...
    O "So the kind-hearted Sibyl who stood by your in your darkest days is the lucky girl to have tied up your heartstrings into knots."
    ...
    H "She doesn't know, Vincenza. Do we crush her heart now or let her it wither in time?"
