...
label act1:
    ...
    "The school which I'm marching toward like death row inmate is where I'll be serving out the remainder of my freshman year of high school."
    "I'm already dressed in my new uniform: an exceptionally cute pink and white outfit, totally unlike what I used to wear at my old public school."
    ...
    "Whether it's my awkward body or because I'm lugging my entire worldly belongings against my hip, the warm white tights keeping the chill away are simply not cooperating."
    C "(They surely have a car that could have met me at the gate rather than force me to suffer exposure to the elements.)"
    "A wave of relief washes over me when I spy the forms of the stately buildings of Prudence Preparatory Academy emerging clearly from the white cover of light snowfall just ahead."
    "Beside what are likely the school buildings and dormitory, there is also a small chapel with a grand statue of some saint or another out front."
    scene bg mary winter snow night with dissolve
    "I perform an clumsy half jig for a few steps in a futile attempt to correct the tights somehow both sagging and bunching around my legs."
    "After finally having enough of the annoyance, I stop right there where I stand to drop the duffel and dig my fingers into the uniform inelegantly, pinching and digging at the tight fabric which runs up to my waist."
    who "Dear me, Vincenza, and in sight of the Virgin Mary too."
    who "The Virgin Mary always watches over us, Vittoria."
    "Unexpectedly out of the lazy snow flurries floats a pair of voices and the titter of laughter against the quiet of the evening dusting of a snowfall."
    "I almost think I'm starting to hear things as a result of my desperate trek, but before I can validate my sanity a sudden weight presses around the back of my neck and upon my shoulders."
    O "The proper young ladies of this academy do such things in the confines of their own rooms."
    "The second girl, which by her voice was addressed as Vincenza, is close enough for me to feel the warmth of her breath tickle the left side of my face."
    ...
    C "(They know my name!?)"  
    "With her right arm still heavy around my shoulders, the girl hanging over my shoulder heedlessly picks at the leftmost strap of my skirt with her left, following it slowly all the way up my chest."
    ...
    C "(Is getting this close normal for Europeans!?)"
    ...
    O "Pity..."
    "Distracted and slowed from logical thought by the strange caresses all over my body, it's only then that my brain finally comes to the heart of the matter."
    C "W-Wait, room key?"
    ...
    "Shaking about like mad trying to fish out the object burning cold against the warm skin inside my tights, the offending item turns out to be a plastic id card with my face on it staring back and a metal carabiner attached to it."
    C "(Room 28.)"
    ...
    "My eyes follow the trail in the thin snow cover to find the pair strolling gaily toward the academy like they weren't just a few seconds ago groping me all over in the middle of the road up to the school."
...
label vertu:
    ...
    C "(So this is a \"roommate\" type of boarding school. Not fancy enough to give each student her own room, huh?)"
    ...
    "Even as I think I should stay as far away as humanely possible, something tickling at my curiosity draws closer to the sleeping figure on the bed."
    "I approach my new roommate cautiously, ready for anything after having already been surprised by the pair of girls from before, but still she remains unstirred."
    ...
    "It's only recently that I've been trying to embrace my \"cute\" side, but so far have totally failed trying to compete with girls like this who are effortless naturals."
    C "(Why does dieting only make my face break out and look extra nasty? What am I doing wrong that this girl is doing right?)"
    ...
    "My annoyance about my name fades with a momentary wave of guilty that I might have suspected her of something terrible when she so clearly put effort into welcoming me into what was previously solely her space."
    C "(Her eyelashes are so long...)"
    "Replete tresses of auburn curls stream from her head, which makes me again flame with envy as someone who has lived with straight hair her entire life."
    ...
    C "(Like hell I'm kissing a stranger though. Gross. Why are old fairy tales always so creepy?)"
    "Little flickers of a dream in progress play cross her sleeping features and make her pale pink lips tremble. It's captivating in a strange way that draws me even closer to lean over the bed."
    play sound bedcreak
    pause 0.5
    ...
    who "...Clover?"
    "The words float out airily behind me, soft enough for them to tickle at my ears and force their way between all the dark thoughts brewing in the back of my head."
    ...
    "More awake than before, anyway. Her long lashes lay heavy over her crisp blue eyes. The soft pout from being pulled out of a dream too early remains on her lips."
    C talk "What do you want?"
    ...
    who "A better introduction than {b}this{/b}. How careless of me to have fallen asleep."
    "I can feel heartbeats go entirely missing within my chest as I watch her quickly lean across to check her alarm clock on the nightstand, then flash her big round eyes back at me."
    ...
    C "I was just surprised to hear you. I'm super late, sore from lugging my bag all the way here, and I ran into two crazy girls on the way here. I want to sleep too."
    ...
    S "I'm so sorry, I meant to be there when you arrived to help you and— oh, my name is Sibyl. Sibyl Hyltebruk."
    ...
    C "Umm... nice to meet you, Sibyl. So we're going to be roommates, huh?"
    ...
    S "Not merely roommates to one another, but Vertu partners. Haven't you read the academy's pamphlet?"
    ...
    "Correctly surmising that I had discarded the dull school literature at first glance, the new roommate launches into her own explanation of what I clearly do not know."
    S "Vertu partners are like... having a best friend or an older sister to help you, and to be that person for your Vertu partner as well."
    ...
    C neutral "That's pretty poetic sounding, huh?"
    ...
    "Even though it's really just some dumb private school way of saying \"roommate\", she keeps saying \"Vertu\" with a strangely serious tone like it is some hallowed institution akin to marriage."
    C "(Like I'd ever marry a girl in the first place...)"
    "Just thinking about two girls together \"like that\" brings the pair from earlier to mind. I can already feel the heat of my boiling blood rising all over my body just thinking what they did to me."
    ...
    S "Maybe I didn't make a good first impression on account of dozing off, but I really would like to help you adjust to the academy."
    C "I don't need help."
    ...
    C "(What's wrong with me today? When did I becomes such a pushover?)"
    S surprise "Oh no, the cafeteria!"
    C surprise "W-What wrong with it?"
    S "It's closed!"
    C "For how long!?"
    ...
    S talk "I must have snoozed right through meal time, and you must be famished too after all that traveling."
    C think "Well... kinda..."
    ...
    S think "I'm afraid not... but, ah, let's go speak to Miss Woolsey. She will definitely be able to help us."
    ...
    S smile "Nonsense! She's our dorm mother; this is exactly what she's here for!"
...
label woolsey_intro:
    ...
    C "(And you know what's also not my fault? The cheap airline only giving out a tiny pretzel snack bag.)"
    who "Sorry girls, I got held up back in the school building."
    "Before I can think of another way out of this, the teacher who must be Miss Woolsey arrives from behind us to fully seal my doom."
    mw "What's the matter, Sibyl— and, oh! You must be Clover! I'm Miss Woolsey, your athletics instructor."
    ...
    S "I, umm, missed her arrival too. I was just too fidgety to sleep at all last night and it finally caught up with me this afternoon."
    ...
    "Miss Woolsey looks to be rather young, probably barely out of college, and not altogether unpleasant at first meeting despite her apparent association with those two sexual predators."
    mw "How are you settling in, Clover? Was there something you needed to speak with me about?"
    "Before I can promptly shut down Miss Woolsey's good-natured assistance, Sibyl speaks out ahead of me."
    S "Yes, there is! You see, it would appear that we both... entirely missed dinner."
    mw "Is that all? Let's go raid the kitchen and see what we can pull together."
    scene bg kitchen with fade
    "The cooks have long ago left for the day when we arrive but that doesn't stop Sibyl and Miss Woolsey from scrounging up enough peanut butter and jelly for sandwiches."
    "It might not be much of a meal, but I am humble enough to privately admit to myself that having food in my grumbling stomach does lighten my mood."
    C "(I've been doing a good job playing nice. I deserve this extra stuffed PB&J. Shame there's no chocolate hazelnut spread or marshmallow creme...)"
    "My roommate and my gym teacher chat with each other while I try to hang back and blend into the refrigerator, but once we're sitting down with sandwiches in hand it's hard to keep their interest off me for long."
    mw "The other students just returned from winter break last week so you'll be able to jump right into lessons together."
    mw "I haven't even gotten all my class plans together yet! Clover, do you prefer tennis, disc golf, or... maybe yoga?"
    "Miss Woolsey turns her gaze on me to await my response. Even Sibyl pauses mid-bite to stare me down in expectation of my answer."
    ...
    mw "My high school masquerade ball was a big day for me in a lot of ways, so I'm glad you enjoyed it so much too. Which animal did you pick?"
    S "The options were sort of picked over but from what was left so I chose the kangaroo."
    ...
    "Much like Sibyl before, Miss Woolsey goes on to tell me how \"special\" being roommates is at this school. Sibyl nods seriously at what the teacher says, giving me an encouraging smile all the while which only makes my stomach flop over inside me."
    ...
    "Miss Woolsey, while friendly, is being awfully persistent at trying to get me to open up when I have no intention of doing so, and the annoyance leads me to say more aloud than I want to."
    ...
    "But to my surprise, Sibyl reaches out to lay her hand on my arm first to offer her condolences without even knowing what I'm going through at all. I pull away suddenly from her touch as quickly and unexpectedly as she'd touched me."
    C "I don't need your apologies."
    ...
    "The long and arduous journey here, the muddled rush of emotions in the past few hours, and everything else swirling together in my skull draws yet another verbal jab which I cannot take back."
    "My shouting is shockingly ineffective on Sibyl, who only follows my angry outburst with a look of pity and understanding."
    S "Oh, Clover..."
    "It's unnerving, to see this strange reaction to me being so frigidly cold. Sibyl's soothing smile and big, sparkling eyes peering out at me drive right through my icy exterior to make my stomach flutter the half-digested sandwich within."
    ...
    C "I-It's fine..."
    C "(I'm sure she's thinking she's only made things worse with her persistent questioning. Maybe I can salvage my gym class grade after all.)"
    ...
    C "...Thanks."
    "I feel like an amoeba under a microscope by the way Sibyl keeps looking at me sympathetically, and then doubly so with how Miss Woolsey is still clearly fretting over our interaction."
    C "(When will this day just {b}end{/b}?)"
    "Rather than make the rest of the night even worse, I just try to focus on filling my mouth with sticky peanut butter and jelly so that I physically cannot reply."
    scene bg dorm night with fade
    "Sibyl and I make our way back to the dorms and say good night to the dorm mother, Miss Woolsey, at long, long last."
    ...
    "What replaces that is the sour recollection of what those two girls did to me that evening, a recollection which doesn't help to calm me down one bit."
    pause 0.5
    ...
    "At times I'm there sleeping in my dormitory bed, listening to the quiet breathing from the next bed over and the music of wind swaying through a thousand bare tree branches outside."
...
label shower_time:
    ...
    "Daylight streams in through the open windows. The restless fits of sleep must have caught up to me at some point in the early morning because I have no recollection of the dawn ever coming."
    ...
    "The cafeteria does not disappoint. The breakfast menu is surprisingly robust — so much that my mouth starts watering just reading the options. For my first ever meal at the academy, I choose a little bit of everything offered."
    "I don't breathe a single word of it aloud to Sibyl, but I actually do feel considerably less cranky and more awake after getting proper food in my stomach."
    ...
    S "Oh, those two are a well-known couple."
    S "For a religious school, homosexuality is remarkably very well tolerated here. I was surprised myself."
    C "(Being religious doesn't mean hating gays. Even I know that and I'm, like, the opposite of religious.)"
    ...
    S "I've only been here a few months but I get what she means now. I guess that sort of thing is just more common at an all-girls school."
    ...
    S "When we did a nude study in the art club— well, anyway, she's a really great art instructor!"
    ...
    menu:
        ...
        "\"I thought it'd be the, uh... nagging club, I don't know.\"":
            ...
            S "Contrary to what you might think, I did have my own life long before you came into it yesterday."
    ...
    S "My friend from the art club. She's unusually late this morning."
    C "You have friends?"
    ...
    "Having made the introductions, our eyes lock together for a brief moment before Tanya breaks into an equally friendly but decidedly more detached greeting."
    T "Nice to meet you, Clover! Are you taking good care of Sibyl for me?"
    "Despite a subtle accent in her speech, Tanya speaks so fluently that it's clear English has been a frequently spoken language for quite some time."
    ...
    C "(And she didn't mention the little fit I threw either so I guess I owe her for that. Not that I care what Tanya thinks of me of course.)"
    ...
    S "We sat beside one another in art club and we kind of hit it off."
    ...
    S "Every night after curfew, I sat in my lonesome room with my only company being the empty bed across the way."
    ...
    C "Tanya hates her own Vertu. Why can't you just switch?"
    T "I would {b}love{/b} to foist Sierra off onto you, but one cannot just {b}trade{/b} a Vertu partner."
    ...
    T "It may have my differences with Sierra but I respect the rules and traditions of this academy more than I dislike her."
...
label after_lunch:
    ...
    "Just like Miss Woolsey, Sibyl is doing the whole \"patience and understanding\" routine like she's certain I'm going to eventually come running to cry on her shoulder."
