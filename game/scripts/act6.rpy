...
label firstdate:
    ...
    "Tanya and I go about our usual weekend routine starting with early morning practice so that no one is any the wiser that we have a date scheduled for later in the day."
    ...
    scene bg bedroom with dissolve
    "We part ways after lunch as usual, but as the time for our rendezvous ticks closer, I still haven't found a good excuse for leaving Sibyl alone and running out on my mystery errand, so I just tell her truthfully."
    ...
    "I try my best to persuade Sibyl that I'm perfectly fine the way I am, but she does not relent until I'm standing in front of the mirror in in the bathroom while Sibyl buzzes around my hair and face with all kinds of products I've never seen her use even once before."
    ...
    C "(It's amazing what a little lip gloss, hair serum, foundation, mascara— okay, maybe it is a bit much after all.)"
    ...
    "Tanya goes for my hair once again, casually twirling my blonde locks around her fingers worn from gripping her lacrosse stick."
    "My own palm relaxes where I had gripped her arm and glides smoothly down it, ultimately resting atop her knee."
    "No words are spoken, but none need to be said. The atmosphere is so charged between us that our lips draw together magnetically once again in another instant."
    C "Hnf."
    T "Mmn."
    "Our first was clean. Pure."
    "The second is anything but. Any pretense of closed-mouth first-date peck is quickly abandoned, and the eagerness with which we both gorge ourselves in one another's lips, teeth, and tongue."
    "The small part of my brain that isn't desperately trying to make sure I remember to stay balanced on the tree branch struggles against the remainder which wants only to get closer to Tanya and drink in her everything."
    "I know well enough that this isn't exactly proper for a first date kiss, and likely Tanya does too, but that doesn't stop either of us from battling for dominance with our tongues."
    "{i}Tanya and Clover, sittin' in a tree. K-I-S-S-I-N-{/i}"
    "Izzie, they'll hear!"
