label firstdate:
    ...
    T "What? No! This is where I go to be {b}alone{/b}. If I don't get some peace from Sierra I might actually murder her for real."
    ...
    T "I'm {b}not{/b} going to murder {b}anyone{/b}, Clover!"
    ...
    menu:
        ...
        "\"If you could have any superpower, what would it be?\"":
            ...
            T "No I'm not."
            "This statement Tanya answers prompty and matter-of-factly."
    ...
    T "I know it might be hard, but would you {b}try{/b} to possess a functioning brain for a moment, Clover?"
    ...
    "The kiss is {b}sublime{/b}, like the kiss I shared with Sibyl but at least three and a five-eighths times better."
...
label sunday_after_date:
    ...
    H "Oh, {b}please{/b}. Get her to tell you some of the tales from her heyday and say that again with a straight face."
    ...
    T "...Let's just say you owe us one, and that you'll promise not to interfere with me or Clover unless we {b}ask{/b} you to do something."
    H "Deal!"
    scene bg lockers with dissolve
...
label datepart2:
    ...
    T "The title is something like {i}Heavy Love{/i}."
    ...
    T "They do it {b}a lot{/b} in later chapters. We might not even get that far."
    ...
    T "But because of the weird rules about publishing this kind of thing in China and Singapore, it's not graphic at all and actually drawn very... {b}metaphorically{/b}."
    C "Metaphorically?"
...
label after_date1:
    ...
    C "(What the heck does that mean? Where are the {b}numbers{/b}?)"
...
label gardening:
    ...
    "The twins take big gulps, trying all the while not to look {b}too{/b} eager so as not to blow their well-crafted cover personas."
    ...
    C "If you're asking if we've... {b}had sex{/b}, that's none of your business."
...
label sibyl_intermission:
    ...
    "I shoot Tanya an evil glare when Sibyl leans in to look closer at my bruise. She sure doesn't seem all that concerned about my injury for someone who is supposed to be {b}dating{/b} me."
...
label seconddate:
    ...
    "A rush of warm fuzzies spreads through my chest. I turn aside slightly to rest my head against the shoulder of my {b}now-officially-a-girlfriend{/b}, facing away so she has easy access to all the hair flowing down my back."
    ...
    T "C-Clover!?"
    C "Is {b}that{/b} what you think of \"us\"!? Are my feelings— just a statistic to you!?"
    ...
    T "{b}Believe it.{/b}"
    "The deep brown of Tanya's eyes {b}burn{/b} into my face half-lidded, while her hands roam from my shoulders, across my chest, past my waist, and finally hook behind my body low upon my back to pull me further atop her."
    ...
    "I hadn't even intended to be reaching {b}that{/b} low just yet, but clearly Tanya was concerned that I might get there enough to stop what we were doing {b}cold{/b}."
    C "Y-Yeah..."
    ...
    C "(There might not ever {b}be{/b} another moment like this.)"
    T "Come here..."
