...
label izzie_lacrosse_request:
    ...
    T "Well, anyway, the important part is that our homecoming coincides with our first home lacrosse match."
...
label aprilfools:
    scene bg transition with fade
    "One more day turns into two, then three, and so on."
    ...
    "Even Tanya has been something of a support for me in the sense that I'd sooner die than have her one up me on anything at all."
    scene bg bedroom with dissolve
    C "Nng... stupid Tanya..."
    ...
    mw "Consider it a done deal, Miss Ipswich! I hope you're ready because those Snipatuit are tough cookies."
