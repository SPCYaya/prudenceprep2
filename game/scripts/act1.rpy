...
label act1:
    ...
    "Another particularly heavy huff flutters past my lips and through the straight cut bangs of my flaxen blonde hair, sending little white flakes fluttering down before me."
    C "And now it's snowing too. Wonderful."
    "I stop to ruffle my hair back and forth, casting off all the snow which had started to accumulate atop my head."
    ...
    "I can almost {b}hear{/b} the voice of my grandparents in my mind as I trudge along slowly toward the school I'm transferring into part way through freshman year."
    "I'm already dressed in my new uniform: a very girly pink and white outfit which is totally unlike what I used to wear back at my old school, and especially how I dressed in middle school."
    "Just about everything related to this sudden transfer has been a headache but the cute uniform is secretly something I actually kind of like — with one exception."
    "Whether the size is wrong for my awkward body or because I'm undertaking this long trek while lugging nearly my entire worldly belongings, the warm white tights just are {b}not{/b} cooperating."
    "I perform an clumsy half jig for a few steps, trying to correct the tights around my legs as I walk."
    ...
    "The surge of emotion is definitely not because I'm excited to get to school. It merely means that I'm almost done with this stupid walk."
    C "(If they're this fancy they surely have a car that could meet me at the gate.)"
    ...
    "After finally having enough of the annoyance, I stop where I stand to fix my tights and dig my fingers into the uniform inelegantly to pinch and dig at the tight fabric which runs up to my waist."
    ...
    O "Do your eyes need a check, Vittoria? Look how cute she is."
    H "A young lady for sure, Vincenza, but the question of her {b}propriety{/b} remains."
    ...
    C "(They know my name!?)"
    "The pair continue on their back and forth with barely an acknowledgement of their hands {b}all over{/b} my body. That one of them somewhat acknowledged my question is a start at least."
    ...
    C "Could you... {b}not{/b}!?"
    H "You want to make a good first impression for your Vertu, isn't that right?"
    ...
    "My body tingles with the smoothness of her touch, however stiff I am with the shock and confusion of someone acting so out of the ordinary and touching me places few strangers would dare."
    ...
    C "Eueh...! D-Don't—"
    "A strange sound emerges from my lips and transforms into a soft puff of warm breath in the cold air before me."
    ...
    "The heavy duffel strap still slung over my shoulder finally drops off as I shake about like mad trying to fish out the object burning cold against my warm skin inside my tights."
    ...
    "My eyes follow the trail in the thin slow layer to find the pair strolling toward the academy like they weren't just a second ago groping me all over in the middle of the road up to the school."
    H "{i}Le abbiamo sicuramente piegato gli spaghetti.{/i}" # we definitely bent her spaghetti
    O "{i}Certamente.{/i}" # for sure
    "I'm half confused and half {b}fuming{/b}. I can feel the heat swelling in my cheeks and in my chest, made visible from which extra puffy breaths of air emerge from my lungs."
    "My whole body is warm — much warmer than before now that I think about it. The chill of the winter has been chased away to be replaced with warm over-sensation."
    C "(What the hell was all that!?)"
    "The two girls are not super far away and I could chase them down if abandon leave my duffel and all my things here, but I don't know exactly what I'd do when I reach them."
    "What I do know is that the warmth I felt while they were close is rapidly being eaten away by the cold sting of the delicate winter breeze so I re-asses the keys to some warm place I now hold in my hand."
...
label vertu:
    ...
    "I find the pastry-named dormitory building easily enough. As I trudge through campus a number of other girls in similar uniform turn to look at me with polite but distant curiosity."
    "Some students even try to  engage me in friendly conversation more deep than directing me to Macaron Dormitory, which they call the \"new\" dorm, but I'm in no mood for it."
    "To all of them I give the same half-hearted smile and brush past once I get what I need. I'm still reeling from my first meeting with students from this academy and don't want to invite another incident."
    ...
    C "(At least I'll finally be able to put down this stupid duffel and stop being bothered.)"
    scene bg bedroom with dissolve
    "When the door opens I find another girl atop one of a pair of beds before me and I blurt out an apology instinctively."
    C "S-Sorry, I—"
    ...
    C "(So this is a... \"roommate\" type of boarding school.)"
    "It's certainly going to be an adjustment from being an only child and having my own room. One of many adjustments in my life that I'm suddenly being asked to make."
    "A rare optimistic thought passes through my mind as I try to close the door behind me."
    C "(If I keep my space from her it shouldn't be a problem.)"
    "But even as I think I should stay as far away as humanely possible, something tickles at my curiosity deep inside which forces me to draw closer to the sleeping figure."
    "Having already been surprised by the pair of girls from before, I approach my new roommate cautiously, ready for anything, but she still remains unstirred."
    C "(She's not... {b}dead{/b}, right?)"
    "I quickly surmise through quick inspection that she likely unintentionally fell asleep and is otherwise perfectly alive and healthy."
    ...
    "Her body is slim and beautiful in a way that I have never been able to accomplish for myself and which sparks intense envy in my chest."
    ...
    "That she's gorgeous is plainly evident. Long auburn curls stream from her head down her back and side, of which I am most jealous, but it doesn't stop there."
    C "(Her eyelashes are so long...)"
    "I look twice just to be sure it's all natural but detect no trace of any makeup whatsoever."
    C "(How can she just {b}effortlessly{/b} be this pretty?)"
    "It's only recently that I've been trying to embrace my \"cute\" side, but so far have totally failed trying compete with girls like this who are natural beauties."
    ...
    "The sudden creak of the bed when I shift more weight against it draws me out of my trance. Pulling myself quickly away the bed, I turn around again toward my own."
    C "(What am I {b}doing{/b}?)"
    "My mind lingers on the mental images of my roommate's sleeping face longer than I would like and my chest thumps softly in my ears while I heft my luggage onto the bed."
    C "(It's been a long day. I'm tired.)"
    "The explanation fits neatly in my mind and I think nothing more of it, instead turning to empty out my stuffed duffel."
    rm "...Clover?"
    ...
    "Once it worms its way into the front of my brain, I whip back around quickly toward my suddenly very awake roommate propped up on one arm."
    ...
    C "What do you want?"
    "I just sort of... blurt it out while my brain is still working to catch up and immediately realize how rude that must sound."
    "Before I can say anything more, I'm caught speechless when she tosses her loosely bound auburn curls with the back of her hand and unexpectedly winces with her eyes cast downward."
    rm "A better introduction than {b}this{/b}. How careless of me to have fallen asleep."
    "My heart skips a beat as I watch her quickly lean across to check her alarm clock on the nightstand, then flash her big eyes back at me."
    ...
    rm "I'm so sorry, I meant to be there when you arrived to help you and— oh, my name is Sibyl."
    "She stills seems half asleep to me by the way her thoughts are coming all at once, but her dopey face is too cheerful and happy to object too strongly against."
    C "Umm... happy to meet you, Sibyl. So we're going to be roommates, huh?"
    "It's merely a polite greeting and a rhetorical question so I turn about to begun unpacking before I get any more caught up in her pitiful, sleepy sad expressions."
    ...
    "But somehow it feels like Sibyl definitely cares in some way that goes unspoken despite how she holds off on lecturing me any further about the topic."
    ...
    S "You're my first Vertu partner, you know that? By chance I was the odd one out in our year and received no Vertu, that is, until we heard you were transferring in."
    ...
    "Just thinking about two girls together like that brings the pair from earlier to mind. I can already feel the heat of my blood boiling just thinking about."
    ...
    C "Thank you, Sibyl, but I'm {b}self-sufficient{/b}."
    ...
    S "I must have snoozed right through meal time, and you must be famished too."
    C "Well... kinda..."
...
scene woolsey_intro:
    ...
    "Sibyl only has to lead me to the end of the floor to find Miss Woolsey's room. We knock but receive no answer."
    S "Hmmm."
    ...
    who "Oh, you must be Clover! I'm Miss Woolsey, your athletics instructor."
    mw "I'm so sorry I couldn't meet you at the gate as planned, but I see Sibyl was able to greet you properly."
    S "About that..."
    "With some obvious embarrassment, Sibyl finally chimes in beside me."
    S "I, umm, missed her arrival too. I was just to fidgety to sleep at all last night and it finally caught up with me this afternoon."
    ...
    S "When I woke up, Clover was already in the room unpacking."
    ...
    "Miss Woolsey looks to be rather young, probably barely out of college, and not altogether unpleasant despite her apparent association with sexual predators."
    ...
    mw "Is that all? Let's go raid the kitchen and see what we can find."
    scene bg black with fade
    ...
    S "But she missed the masquerade ball, which is a pity. It was a lot of fun."
    ...
    "That I've been staring at my sandwich should have indicated I don't particularly care to talk, but it seems that Miss Woolsey isn't content in reminiscing with fond memories of her school days."
    ...
    "Miss Woolsey also picks up on my little faux pas easily enough, so it seems. Much like Sibyl before, she goes on to tell me how \"special\" being roommates is at this school."
    ...
    "It's the teacher's job to look after me just as much as it is Sibyl's responsibility to be my \"Vertu\"."
    ...
    "Her kindness and efforts to connect with me and make me open up about myself have been honest however clumsy they may be."
    ...
    mw "W-Well... I have long felt like the people I met here at the academy are like a second family to me, so if you ever need—"
    ...
    C "(I'm sure she's thinking she's only made things worse with her prying.)"
    ...
    mw "Just know that if there's anything you don't feel comfortable talking about with Sibyl, you can always call on me too."
    C "...Thanks."
    ...
    "There's a notable difference in the way Sibyl acts toward me since the awkward conversation in the kitchen, which for some reason bothers me way more than I want to care about."
    ...
    S "Good night, Clover."
    "The voice of the roommate I was trying to avoid thinking about floats my direction through the darkness and I stammer out a short but polite reply of my own."
    "The half naked form of Sibyl undressing lingers faintly in my mind as I clamber into my bed for the night despite my best to brush it out along with the unpleasantness of the day's events."
    ...
    "The phantom Sibyls say nothing, merely giving me that infuriatingly knowing smile she made in the kitchen."
    C "Hahn!"
...
label shower_time:
    ...
    "I'd obviously prefer that they stay together, but things as they are know is nothing short of suffocating even if they try to hide it from me."
    "It's like the only thing they agree on nowadays is dumping me in this far away place with only a cutesy uniform and a duffel bag of clothes to my name."
    "Wetness streaks down my cheeks as I blindly fumble for my shampoo. I find the bottle, squeeze it, and quickly freeze up."
    "The sweet, floral scent brings flashes of Sibyl's sleeping face to my mind's eye. They push aside the pain of my previous thoughts but make me feel no more at ease."
    "Water splashes all around me as I shake my head in a flurry of water droplet, but I manage to successfully to banish the images from my mind and find my own shampoo bottle."
    jump breakfast
...
label breakfast:
    ...
    "As I watch various pairs file into teh cafeteria, I also begin to notice how close a few of these pairs seem to be, often holding hands and just generally being exceptionally chummy."
    ...
    S "Oh, yeah. When I first decided I wanted to apply here one of my older sisters stated with such horror: \"A {b}girls'{/b} school? With no {b}boys{/b}?\"."
    S "I've only been here half a year but I get what she means now. I guess that kind of thing is just more common at an all girls school."
    C "Uh huh...?"
    ...
    S "For a religious school, homosexuality is very well tolerated here. I was surprised myself."
    ...
    menu:
        ...
        "\"I thought it'd be the, uh... nagging club, I don't know.\"":
            ...
            "Sibyl, rather than jab back, chooses to politely shut me down, and I lose the one thing keeping me entertained just as easily."
    ...
    C "Ipswich."
    S "Thanks. Clover, this is my best friend, Tanya Yang."
    "Having made the introductions, our eyes lock together for a brief moment before she breaks into an equally friendly but decidedly more distant greeting."
    T "Nice to meet you, Clover! Are you taking good care of Sibyl for me?"
    "There's a subtle accent in her husky-toned speech but she speaks so fluently that it's clear English has been a native language for quite some time."
    ...
    "Sibyl and tanya are obviously close already, even after just half a school year together. The pair walk quite close side-by-side all the way up to the kitchens."
    "Tanya in particular doesn't seem at all hesitant to softly lean on Sibyl's arm as they laugh about something to one another, and Sibyl is quite happy to accept the intimate friendship."
    "The whole display leaves a bitter taste in my mouth as I think about my friends back home, all of which seem to have slowly forgotten about me as things change and life goes on."
    ...
    S "I quickly found that my first few weeks here were nothing but eating alone and going to classes alone while everyone else was still settling into life with their Vertus."
    ...
    T "I'd {b}love{/b} to foist Sierra off onto you, but you can't just {b}switch{/b} your Vertu partner."
    ...
    "Tanya, meanwhile, quickly finishes her yogurt parfait which cuts the conversation short and allows us to head to our classroom early."
    jump class_intro
...
label class_intro:
    ...
    menu:
        "\"I think I'm gonna throw up...\"":
            ...
            "I can't see what I look like but I {b}feel{/b} positively {b}green{/b} just standing there at the front of the classroom with every eye on me."
            "From within the haze of my mind I hear the teacher ask if I need to see the nurse. On instinct I state the truth that I just need to sit down."
        ...
        "\"I-I can't stop thinking about Sibyl's underwear.\"":
            ...
            "Tthe sweet relief of a lightning strike from the heavens never comes, however, and I quickly stammer out a weak explanation in possibly the highest pitched voice to ever leave my throat."
...
label after_lunch:
    ...
    "The words of the open book read through my brain without being processed as anything sensible, much like the titles before them."
    ...
    "All of that just feels like extra bitter icing on the terrible cake of my life in recent weeks. My whole life really started falling apart before I even got here."
    ...
    "I don't know when it started, but the tickle of a wet drop running down my arm alerts to me both that my face is buried in one of my hands and that I'm just barely choking back tears."
    ...
    "Perhaps in a touch better spirits now than before, I rise from my seat to replace the book and continue on to the next stop in my meandering exploration of the school building."
    scene bg hallway with dissolve
    ...
    C "You're all running away from me too? Fine, I came here to be alone anyway."
    "The early classes were actually a welcome distraction, even the French class in which I was totally lost without Sibyl whispering me the translations every three seconds."
    "There was also an etiquette class, which was a complete surprise that was also totally unwelcome for a girl of my sensibilities."
    ...
    C "Sibyl?"
    "There's a light swell in my chest which surprises even me as I look expectantly toward the doorway but it's not luxurious mahogany curls which I see flutter through the doorway."
    ...
    C "She's the one always saying that we're partners and we're supposed to support each other. Why didn't she come looking for me when I vanished?"
    ...
    "My petulant behavior has clearly ticked her off. Her hair is ever so slightly amiss from my shove, however light it was, and her cheeks flush a faint pink from her apparent consternation."
    ...
    T "Every time someone tries to help you or do a single thing nice to you, you have to spit back in their face!"
    ...
    "With the irate presence before me suddenly gone, I slump down on the ground right there with my back against the cold, hard glass."
    ...
    "Of everything Tanya said, what is most strange to me is her assertion that Sibyl feels she's uniquely equipped to resolve all my problems."
    pause 0.5
    ...
    scene bg hallway with dissolve
    " As stealthily as I can I creep down the hallway like the heroine of a spy movie, mostly successfully, until I turn around a corner straight into the worst possible pairing I could."
    H "There she is, our missing Clover!"
    O "Flaunting curfew on your first da—"
    "Before they can even begin doing anything {b}weird{/b} I take off running down the hallway. Thankfully, they don't appear to be taking up chase behind."
    scene bg dorm with dissolve
    ...
    "The first thing I see when I come down the hallway is Sibyl, pacing anxiously in place outside the door."
    C "(Uh oh.)"
    ...
    "Without hesitation she throw her arms around me in a warm hug which could thaw the coldest outdoor chill."
    S "You made it back!"
    C "Y-Yeah..."
    ...
    C "(It's she being a little too worried about me here? Did she think I was going to commit {b}suicide{/b}?)"
    "I cannot begin to fathom what she thought I might have done. I'm already regretting merely having skipped dinner for the second day in a row; I'm way too much of a coward to {b}kill myself{/b}."
    C "Why do you care so much about me? You don't even {b}know{/b} me."
    "I try to spit out the words with as much edge as I can to give off the impression that I don't really care, but deep down the mystery is eating at me."
    ...
    "She's not a real sibyl like the women of ancient days who sat in their high temples and divined the Gods' truths, no matter what her name may be. She can't know anything about me."
    S "I'll wait as long as it takes for you to come around, so when you're ready to talk about anything I'll be right here."
    "Just like Miss Woolsey, Sibyl is doing the whole patience and understanding routine like I'm going to eventually come running to cry on her shoudler."
    ...
    "I jump across the room and clutch at my smartphone to find one missed call and a text message following it."
    "I read out the text three times at least: \"Hi sweetie, how was your first day at school?\""
    "It's from my mom. She's asking about my first day at school like it wasn't half her idea to drag me out of my old school and abandon me here at this one."
    "Or like she isn't conspiring with my dad to tear our family apart and destroy our lives together, the life I've always known and loved up until just recently."
...
label a1_art:
    ...
    "Sibyl brings food back for me even though I refuse to eat it when she's around. I'm grateful for it, but I just don't want to see her warm, compassionate smile while I'm feeling so terrible."
    scene bg bedroom with dissolve
    "On the third day I am awoken the next day with the gentle sound of Sibyl's voice calling my name."
    S "Clover..."
    ...
    C "No."
    S "Hmmm..."
    "I think, for a moment, that I've won against all odds, but then I feel cold fingers tighten around my ankles."
    C "What are you—"
    S "{b}Hnnngg!{/b}"
    ...
    "I'm sure she must have a good reason to bring it up like this but it's hard to be excited like she thinks I should be for something I have no idea about in the first place."
    ...
    "Sibyl remains by my side regardless of whatever Tanya says. Despite not wanting to interact wth me at all, Tanya never leaves Sibyl's side either."
    who "So cute! And such silky hair too!"
    ...
    "It seems word of my complaints about those girls has spread past more than Sibyl, to whom I have already plenty blabbed my complaints while half asleep."
    C "Umm... could you not?"
    who "So {i}tsun{/i} too!"
    ...
    "Whatever is up with this oddity, I don't like it. She clearly knows who I am already, is possibly in league with my two previous assailants, and clearly has no issue with invading my personal space."
    C "(This one is big trouble. I hope I don't have any classes with her.)"
    S "Clover, this is—"
    mi "Miss Izzie!"
    ...
    S "I think that's enough, Miss Izzie. Clover has been... sick the past few days and is still recovering."
    "I quickly find that I actually like how differently she chooses to dress and how freely ehr actions follow her heart, now that Sibyl has helpfully dragged her back to a respectable student-teacher distance."
    C "(So my old appetite for non-conformity still has not yet disappeared entirely.)"
    ...
    menu:
        "\"I've done a few séances in the past...\"":
            ...
            "I can still remember the huge smile on my friend's little brother's face when he was able to speak with their old pet cat again."
        ...
        "\"My old classmate told me I was the state's foremost expert with Ouija boards.\"":
            hide choice_darkness with dissolve
            "What I say is the total truth, except that they said it in a way less flattering manner."
            C "(The spirits were not very kind to her after that.)"
    "From behind me there's a quiet snicker, and with a quick glance I'm both surprised and slightly hurt to find the sound originate from Sibyl rather than Tanya as I had expected."
    ...
    "Just as I'm getting ready to fight off my teacher's ideas on throwing me into a dumb art project, Sibyl unexpectedly comes to my rescue."
    S "Miss Izzie? Could I have Clover sit as a model for an oil pastel portrait? She can learn more from me while she considers what she wants to start with for herself."
    ...
    "Tanya follows off after her to speak to the teacher further about something. I'm just glad to have the former's high energy presence kept away so I can calm down again."
    ...
    C "Y-You actually believe in all that?"
    ...
    S "I know it's all fluff but it's still fun to think about. And I'm very open-minded in general, so I like to think."
    C "I just can't imagine that you or anyone else at this school would find the supernatural and macabre to be interesting."
    S "Do you really figure me to be the stuffy type?"
    ...
    menu:
        "\"Why am I naked?\"":
            ...
            C "No, I really don't."
            mi "It's {i}The Birth of Venus{/i} by Botticelli, but with Clover and her namesake plant! I love it!"
            ...
            "With another look between the faux nude drawing of me and the real thing, the strange teacher wanders off to see to other students again."
            C "I still don't understand why you needed me to be naked."
            S "The human form has long been a subject of artists' curiosity, but it's okay if you don't quite get it yet."
...
label home_ec:
    ...
    "Making food isn't the entirety of the class, I am sad to learn from the teacher. We also have boring lessons like sewing and tax preparation too."
    S "Got it! Here we go!"
    ...
    S "Hmph, you want to know more about them and not me? Here I was hoping you'd finally opened up."
    C "I-I'm not opening up, I just want to... get revenge. Or something."
    S "Revenge? For a little unwanted flirting? I don't condone their actions but there are quite a few girls here who would gladly have taken your place, you know."
    ...
    S "No, but they are European. They're Italian."
    ...
    "This is starting to sound more and more problematic, but I still want my payback for jumping me before I even had the chance to step foot onto school grounds proper."
    ...
    S "They're really nice when you get to know them. They even helped look for you when you went missing."
    "Sibyl details to me where to find the Student Council room which I commit to memory."
    "Maybe she's expecting that I need more help or just hoping to get more information out of me, but Sibyl keeps talking even after I learn what I needed."
    S "Would you like me to come along?"
    C "(Why would I need her to come with me for this?)"
...
label student_council:
    ...
    "I part ways with Sibyl at the end of classes. She heads back toward the school building to go to club and I make for the chamber where the Student Council meets."
    ...
    C "Here we go!"
    "From outside the doorway to the meeting room muffled voices seep through the edges of the doorway. I knock at the door ten push it open while vim and vigor of unsatisfied revenge yet flows through me."
    ...
    "There's a momentary glance between the twins before Vincenza leans toward the vocal member to casually flit a finger through one side of her bangs while coolly looking into her face."
    ...
    "All my devious plans fly right out the window, leaving me staring down my devious attackers directly as they quip to one another like I'm not even in the room."
    ...
    O "From what we have heard, we may be partially to blame for that."
    C "(Just how far has my beef with the twin been spreading? Is Sibyl talking about me behind my back?)"
    H "Therefore, we would like to apologize for any offense we may have paid to you."
    ...
    "I'm clear out of ideas of what to do now to get my revenge, and the twins themselves not being frightened in the slightest is taking all the wind out of my efforts."
    C "Just... apologize and promise you won't do it again."
    H "We are sorry for having been too forward, Clover."
    ...
    C "Okay, fine, I accept your apology. But if I catch you doing it again, I won't go so easy on you!"
    ...
    "With my feelings about the matter jumbled I suddenly feel like putting it all behind me at once and getting these two out of my sight immediately, but Vincenza stops me."
    ...
    H "We know you've been struggling to adjust to your surroundings here and would like to help you as we can."
    ...
    O "It's touching how deeply she cares about your struggles despite how short of a time she has known you."
    ...
    "I say it with the utmost defiance, the reality of which only hits me when I see the deeply concerned looks returned to me from across the table."
    ...
    H "Your attitude is unpleasant and has been turning away everyone you come into contact with."
    ...
    C "There's nothing {b}wrong{/b} with me, it's {b}everything else{/b} in my life that's all screwed up!"
    jump introspection
...
label introspection:
    ...
    "With the strange emptiness of my now-resolved conflict with the twins still lingering, I search the faces of the other students around me for any truth in what the they had said."
    ...
    "My introduction was a spectacular failure so I had written off ever speaking to anyone from then on, but despite my fears the pair only seemed curious about me when they looked my way."
    C "(Can I pull off \"cool\"? Probably not. \"Mysterious\"? Maybe. \"Beautiful\"? Sounds like a lot of work.)"
    "Some part of me refuses to accept they were merely curious about me and that they must have instead been secretly mocking me."
    "I would believe anything if it means not having to admit that Vittoria and Vincenza may have been right."
    ...
    scene bg bedroom with dissolve
    "It's a relief when I finally get back to my room, far away from any curious or potentially judgemental eyes."
    C "(What's this?)"
    ...
    "A blanket of chill drapes over my shoulders as I read the familiar address of the sender."
    ...
    "I fight back my tears reading their note, which is full of love and encouragement to make new friends at the academy."
    C "Mom... Dad..."
    ...
    "I've always known deep down that my parents still love me, and I do them, but seeing it written after unwrapping all the thoughtful makes the weight of their love rest heavily in my chest."
    "They mention nothing about the divorce that I know is still looming like the blade of a guillotine over everything, but for the moment the letter contains the same love and comfort I've always known."
    ...
    "I pick up the letter again, read a few lines written by my Dad, and somehow find my head clearer than it's been in recent memory."
    ...
    S "It's delicious!"
    C "(She probably has no idea how much this peanut brittle means to me, but she also probably deserves this little bit for having put up with me the past few days.)"
    "That's right, I am all but forced to admit that {b}maybe{/b} Sibyl was right about her \"storm clouds\", and that I have been a touch dramatic ever since coming here."
    "Turning again to the photos, I pluck the photo of my beloved pet off the top of the stack to push toward her."
    C "And some of my photo frames too. It feels like I haven't seen Abraxas in months, but I know it's only been a week or so."
    S "What's a \"braxas\"?"
    ...
    "Sibyl reaches out unbidden to twirl my hair through her fingers and tease the ends of my hair. It's even more unbearably embarrassing than I could possibly have expected it to be."
    ...
    "Sibyl laughs shortly at my question, not with malice, but apparently at how absurd it is and probably also whatever pitiful expression I have on my face."
    ...
    "it might not have been a big thing to Sibyl, but what she says leaves me dazed. Not hearing me reply, Sibyl stops to look back at me in concern, whispering my name with uncertainty."
    S "Clover...?"
    C "(Mom, Dad, I'm {b}so{/b} sorry...)"
    "All at once I realize what I fool I've been. For weeks I've felt that being sent here to the academy must be some kind of punishment or abandonment. Now I finally come to realize that they did this all for me."
