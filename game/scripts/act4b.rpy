label tanya_injured:
    ...
    C "I've let myself down. I've let Ms. Woolsey down, again, for the bajillionth time. And now I've gone and let the whole team down too."
...
label finalgame:
    ...
    "Ms. Woolsey spots us quickly and gives us a small wave from the sidelines. Though the spectator seating is more full than most besides the game before Homecoming, we're easy to pick out on account of the giant banners we're waving."
    S "{b}Prudence!{/b}"
    T "{b}Wild!{/b}"
    C "{b}Roses!{/b}"
...
label yearbooks_part2:
    ...
    T "We have to hurry, Clover, everyone's already gathered around Ms. Woolsey!"
    scene bg gym with dissolve
    ...
    S "Ms. Woolsey wrote a lot in your yearbook, didn't she? She's so thoughtful."
    ...
    C "Yeah, I know what you mean. Ms. Woolsey is a natural coach. She's the kindest and most supportive woman in the world, but she can be tough too."
    ...
    C "Y-You think?"
    "Just knowing that they're talking about me drives me mildly crazy, but I manage to resist the overwhelming urge to ask Tanya what Ms. Woolsey had said about me when she returns and mentions nothing of it."
